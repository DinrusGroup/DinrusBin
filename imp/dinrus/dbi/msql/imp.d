...
/**
 * Get the number of поля in a result set.
 *
 * Params:
 *	result = The result set to read from.
 *
 ...
 *
 * Params:
 *	host = The имя or IP address of the server to connect to.  Use null for localhost.
 *
 * Returns:
 ...
 *	dbName = The имя of the database to use.
 *
 * Returns:
 *	-1 on failure.
 */
 ...
 *
 * Params:
 *	date1 = A string containing "DD:Mon:YYYY" using English месяц names.
 *	date2 = A string containing "DD:Mon:YYYY" using English месяц names.
 *
 * Returns:
...
/**
 * Convert a standard UNIX время to a mSQL время.
 *
 * Params:
 *	clock = The number of секунды since January 1, 1970.
 *
 * Returns:
 *	A string containing "HH:MM:SS" in a 24 час format.
 */
char* msqlUnixTimeToTime (int clock);

/**
 * Convert a standard UNIX время to a mSQL date.
 *
 * Params:
 *	clock = The number of секунды since January 1, 1970.
 *
 * Returns:
 *	A string containing "DD:Mon:YYYY" using English месяц names.
 */
 ...
 *
 * Params:
 *	time1 = A string containing "HH:MM:SS" in a 24 час format.
 *	time2 = A string containing "HH:MM:SS" in a 24 час format.
 *
 * Returns:
...
/**
 * Change a mSQL date by a certain amount of время.
 *
 * Params:
 *	date = A string containing "DD:Mon:YYYY" using English месяц names.
 *	dOff = The number of days to move.
 *	mOff = The number of months to move.
 *	yOff = The number of years to move.
 *
 * Returns:
 *	A string containing "DD:Mon:YYYY" using English месяц names offset the specified amount of время.
 */
 ...
 *
 * Returns:
 *	The next row if it есть or null otherwise.
 */
...
/**
 * Get information about what тип of data can be stored in a field.
 *
 * Params:
 *	result = The result set to analyze.
 *
 * Returns:
 *	The next field if it есть or null otherwise.
 */
 ...
 *
 * Returns:
 *	A result set with a single field containing the таблица names.
 */
m_result* msqlListTables (int sock);

/**
 * Get the names of all of the поля in the current database.
 *
 * Params:
 *	sock = The database handle.
 *
 ...
 * Params:
 *	sock = The database handle.
 *	tableName = The имя of the таблица to analyze.
 *	index = The тип of index.  Only "avl" is accepted right now.
 *
 * Returns:
...
/**
 * Convert a mSQL время to a standard UNIX время.
 *
 * Params:
 *	msqltime = A string containing "HH:MM:SS" in a 24 час format.
 *
 * Returns:
 *	The number of секунды since January 1, 1970.
 */
time_t msqlTimeToUnixTime (char* msqltime);

/**
 * Convert a mSQL date to a standard UNIX время.
 *
 * Params:
 *	msqldate = A string containing "DD:Mon:YYYY" using English месяц names.
 *
 * Returns:
 *	The number of секунды since January 1, 1970.
 */
