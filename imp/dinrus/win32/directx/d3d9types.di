...
enum : D3DSAMPLER_TEXTURE_TYPE {
    D3DSTT_UNKNOWN = 0<<D3DSP_TEXTURETYPE_ШИФТ, // uninitialized value
...
const D3DSPDM_SATURATE = (1<<D3DSP_DSTMOD_ШИФТ); // clamp to 0. to 1. range
...
enum : D3DSHADER_PARAM_SRCMOD_TYPE {
    ...
    D3DSPSM_ABS     = 11<<D3DSP_SRCMOD_ШИФТ, // abs()
    D3DSPSM_ABSNEG  = 12<<D3DSP_SRCMOD_ШИФТ, // -abs()
...
uint D3DSHADER_COMMENT(ushort _DWordSize) { return (((_DWordSize<<D3DSI_COMMENTSIZE_ШИФТ)&D3DSI_COMMENTSIZE_MASK)|D3DSIO_COMMENT); }
