...
const D3D10_ШИФТ_INSTRUCTION_PAD_VALUE = 0;
const D3D10_ШИФТ_INSTRUCTION_ШИФТ_VALUE_BIT_COUNT = 5;
...
const D3D10_MIN_FILTER_ШИФТ = 4;

const D3D10_MAG_FILTER_ШИФТ = 2;

const D3D10_MIP_FILTER_ШИФТ = 0;
...
D3D10_FILTER D3D10_ENCODE_BASIC_FILTER(int min, int mag, int mip, bool bComparison) {
	return cast(D3D10_FILTER)(((bComparison) ? D3D10_COMPARISON_FILTERING_BIT : 0) |
	       ((min & D3D10_FILTER_TYPE_MASK) << D3D10_MIN_FILTER_ШИФТ) |
		   ((mag & D3D10_FILTER_TYPE_MASK) << D3D10_MAG_FILTER_ШИФТ) |
		   ((mip & D3D10_FILTER_TYPE_MASK) << D3D10_MIP_FILTER_ШИФТ));
}
...
D3D10_FILTER_TYPE D3D10_DECODE_MIN_FILTER(D3D10_FILTER d3d10Filter) {
	return cast(D3D10_FILTER_TYPE)((d3d10Filter >> D3D10_MIN_FILTER_ШИФТ) & D3D10_FILTER_TYPE_MASK);
}

D3D10_FILTER_TYPE D3D10_DECODE_MAG_FILTER(D3D10_FILTER d3d10Filter) {
	return cast(D3D10_FILTER_TYPE)((d3d10Filter >> D3D10_MAG_FILTER_ШИФТ) & D3D10_FILTER_TYPE_MASK);
}

D3D10_FILTER_TYPE D3D10_DECODE_MIP_FILTER(D3D10_FILTER d3d10Filter) {
	return cast(D3D10_FILTER_TYPE)((d3d10Filter >> D3D10_MIP_FILTER_ШИФТ) & D3D10_FILTER_TYPE_MASK);
}
