...
static if (_WIN32_WINNT_ONLY) {
	static if (_WIN32_WINNT >= 0x500) {
		enum {
			/* WinNT5+:
			   ms-help://MS.MSDNQTR.2003FEB.1033/winsock/winsock/win32.winsock2.SOCKET_options.htm */
			SO_MAXDG             = 0x7009,
			SO_MAXPATHDG         = 0x700A,
		}
	}
	...
	enum {
		/* WinNT4+:
		   ms-help://MS.MSDNQTR.2003FEB.1033/winsock/winsock/win32.winsock2.SOCKET_options_for_windows_nt_4_0_2.htm */
		SO_CONNDATA              = 0x7000,
		SO_CONNOPT               = 0x7001,
		SO_DISCDATA              = 0x7002,
		SO_DISCOPT               = 0x7003,
...
extern(Windows) {
	...
	static if (_WIN32_WINNT_ONLY) {
		/* WinNT3.51+
		   ms-help://MS.MSDNQTR.2003FEB.1033/winsock/winsock/transmitfile_2.htm */
		BOOL TransmitFile(win32.winsock2.SOCKET, HANDLE, DWORD, DWORD, LPOVERLAPPED, LPTRANSMIT_FILE_BUFFERS, DWORD);
...
version(Win32_Winsock1) {
	...
	static if (WINVER > 0x501) {
		...
		extern(Windows)
		{
			 ...
			 */
			BOOL DisconnectEx(win32.winsock2.SOCKET, LPOVERLAPPED, DWORD, DWORD);
