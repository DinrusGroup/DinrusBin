...
import sys.DConsts:МАСКА_ВВПАРАМ, ВВК_ВХО, ВВФСБВВ, СОКОШИБ, ПОпцияСокета, ППротокол, ПТипСок, ПСемействоАдресов, ПЭкстрЗакрытиеСокета, ПФлагиСокета, ПФлагиАИ, ПОшибкаАИ,  ПФлагиУИ, ПИмИнфо;

import sys.DStructs: ВИНСОКДАН, ВИНСОКБУФ, набор_уд, значврем, хостзап, адрессок, заминка, адрес_ин, протзап, служзап, адринфо;
