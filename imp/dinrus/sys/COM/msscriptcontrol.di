...
private import tpl.com, sys.WinStructs, sys.WinIfaces;
...
IDispatch
{
    mixin(ууид("70841c73-067d-11d0-95d8-00a02463ab28"));
...
IDispatch
{
    mixin(ууид("70841c71-067d-11d0-95d8-00a02463ab28"));
...
IDispatch
{
    mixin(ууид("70841c70-067d-11d0-95d8-00a02463ab28"));
    int get_Name(out wchar* pbstrName);
...
IDispatch
{
    mixin(ууид("70841c6f-067d-11d0-95d8-00a02463ab28"));
...
IDispatch
{
    mixin(ууид("70841c78-067d-11d0-95d8-00a02463ab28"));
...
IDispatch
{
    mixin(ууид("0e59f1d3-1fbe-11d0-8ff2-00a0d10038bc"));
...
IDispatch
{
    mixin(ууид("8b167d60-8605-11d0-abcb-00a0c90fffc0"));
    /+void Error();
    +/
    /+void Timeout();
    +/
...
{
    mixin(ууид("0e59f1d5-1fbe-11d0-8ff2-00a0d10038bc"));
    mixin Интерфейсы!(IScriptControl);
}
