...
DnsHostnameToComputerNameA PROTO STDCALL :
DWORD,:
DWORD,:
    DWORD
    IFNDEF __UNICODE__
...
DnsHostnameToComputerNameW PROTO STDCALL :
DWORD,:
DWORD,:
    DWORD
    IFDEF __UNICODE__
...
DosDateTimeToFileTime PROTO STDCALL :
DWORD,:
DWORD,:
    DWORD
DuplicateHandle PROTO STDCALL :
DWORD,:
DWORD,:
DWORD,:
DWORD,:
...
DWORD,:
    DWORD
EncodePointer PROTO STDCALL :
    DWORD
EncodeSystemPointer PROTO STDCALL :
    DWORD

EndUpdateResourceA PROTO STDCALL :
DWORD,:
    DWORD
    IFNDEF __UNICODE__
...
EndUpdateResourceW PROTO STDCALL :
DWORD,:
    DWORD
    IFDEF __UNICODE__
...
EnterCriticalSection PROTO STDCALL :
    DWORD

EnumCalendarInfoA PROTO STDCALL :
DWORD,:
DWORD,:
DWORD,:
    DWORD
...
EnumCalendarInfoExA PROTO STDCALL :
DWORD,:
DWORD,:
DWORD,:
    DWORD
...
EnumCalendarInfoExW PROTO STDCALL :
DWORD,:
DWORD,:
DWORD,:
    DWORD
...
EnumCalendarInfoW PROTO STDCALL :
DWORD,:
DWORD,:
DWORD,:
    DWORD
...
EnumDateFormatsA PROTO STDCALL :
DWORD,:
DWORD,:
    DWORD
    IFNDEF __UNICODE__
...
EnumDateFormatsExA PROTO STDCALL :
DWORD,:
DWORD,:
    DWORD
    IFNDEF __UNICODE__
...
EnumDateFormatsExW PROTO STDCALL :
DWORD,:
DWORD,:
    DWORD
    IFDEF __UNICODE__
...
EnumDateFormatsW PROTO STDCALL :
DWORD,:
DWORD,:
    DWORD
    IFDEF __UNICODE__
...
EnumLanguageGroupLocalesA PROTO STDCALL :
DWORD,:
DWORD,:
DWORD,:
    DWORD
...
EnumLanguageGroupLocalesW PROTO STDCALL :
DWORD,:
DWORD,:
DWORD,:
    DWORD
...
EnumResourceLanguagesA PROTO STDCALL :
DWORD,:
DWORD,:
DWORD,:
DWORD,:
...
EnumResourceLanguagesW PROTO STDCALL :
DWORD,:
DWORD,:
DWORD,:
DWORD,:
...
EnumResourceNamesA PROTO STDCALL :
DWORD,:
DWORD,:
DWORD,:
    DWORD
...
EnumResourceNamesW PROTO STDCALL :
DWORD,:
DWORD,:
DWORD,:
    DWORD
...
EnumResourceTypesA PROTO STDCALL :
DWORD,:
DWORD,:
    DWORD
    IFNDEF __UNICODE__
...
EnumResourceTypesW PROTO STDCALL :
DWORD,:
DWORD,:
    DWORD
    IFDEF __UNICODE__
...
EnumSystemCodePagesA PROTO STDCALL :
DWORD,:
    DWORD
    IFNDEF __UNICODE__
...
EnumSystemCodePagesW PROTO STDCALL :
DWORD,:
    DWORD
    IFDEF __UNICODE__
...
EnumSystemGeoID PROTO STDCALL :
DWORD,:
DWORD,:
    DWORD

EnumSystemLanguageGroupsA PROTO STDCALL :
DWORD,:
DWORD,:
    DWORD
    IFNDEF __UNICODE__
...
EnumSystemLanguageGroupsW PROTO STDCALL :
DWORD,:
DWORD,:
    DWORD
    IFDEF __UNICODE__
...
EnumSystemLocalesA PROTO STDCALL :
DWORD,:
    DWORD
    IFNDEF __UNICODE__
...
EnumSystemLocalesW PROTO STDCALL :
DWORD,:
    DWORD
    IFDEF __UNICODE__
...
EnumTimeFormatsA PROTO STDCALL :
DWORD,:
DWORD,:
    DWORD
    IFNDEF __UNICODE__
...
EnumTimeFormatsW PROTO STDCALL :
DWORD,:
DWORD,:
    DWORD
    IFDEF __UNICODE__
...
EnumUILanguagesA PROTO STDCALL :
DWORD,:
DWORD,:
    DWORD
    IFNDEF __UNICODE__
...
EnumUILanguagesW PROTO STDCALL :
DWORD,:
DWORD,:
    DWORD
    IFDEF __UNICODE__
...
EnumerateLocalComputerNamesA PROTO STDCALL :
DWORD,:
DWORD,:
DWORD,:
    DWORD
...
EnumerateLocalComputerNamesW PROTO STDCALL :
DWORD,:
DWORD,:
DWORD,:
    DWORD
...
EraseTape PROTO STDCALL :
DWORD,:
DWORD,:
    DWORD
EscapeCommFunction PROTO STDCALL :
DWORD,:
    DWORD
ExitProcess PROTO STDCALL :
    DWORD
ExitThread PROTO STDCALL :
    DWORD

ExpandEnvironmentStringsA PROTO STDCALL :
DWORD,:
DWORD,:
    DWORD
    IFNDEF __UNICODE__
...
ExpandEnvironmentStringsW PROTO STDCALL :
DWORD,:
DWORD,:
    DWORD
    IFDEF __UNICODE__
...
FatalExit PROTO STDCALL :
    DWORD
FileTimeToDosDateTime PROTO STDCALL :
DWORD,:
DWORD,:
    DWORD
FileTimeToLocalFileTime PROTO STDCALL :
DWORD,:
    DWORD
FileTimeToSystemTime PROTO STDCALL :
DWORD,:
    DWORD
...
FillConsoleOutputCharacterW PROTO STDCALL :
DWORD,:
DWORD,:
DWORD,:
DWORD,:
...
FindActCtxSectionGuid PROTO STDCALL :
DWORD,:
DWORD,:
DWORD,:
DWORD,:
...
FindActCtxSectionStringA PROTO STDCALL :
DWORD,:
DWORD,:
DWORD,:
DWORD,:
...
FindActCtxSectionStringW PROTO STDCALL :
DWORD,:
DWORD,:
DWORD,:
DWORD,:
...
FindAtomA PROTO STDCALL :
    DWORD
    IFNDEF __UNICODE__
    FindAtom equ <FindAtomA>
    ENDIF

FindAtomW PROTO STDCALL :
    DWORD
    IFDEF __UNICODE__
    FindAtom equ <FindAtomW>
    ENDIF

FindClose PROTO STDCALL :
    DWORD
FindCloseChangeNotification PROTO STDCALL :
    DWORD

FindFirstChangeNotificationA PROTO STDCALL :
DWORD,:
DWORD,:
    DWORD
    IFNDEF __UNICODE__
...
FindFirstChangeNotificationW PROTO STDCALL :
DWORD,:
DWORD,:
    DWORD
    IFDEF __UNICODE__
...
FindFirstFileExA PROTO STDCALL :
DWORD,:
DWORD,:
DWORD,:
DWORD,:
...
FindFirstFileExW PROTO STDCALL :
DWORD,:
DWORD,:
DWORD,:
DWORD,:
...
FindFirstVolumeA PROTO STDCALL :
DWORD,:
    DWORD
    IFNDEF __UNICODE__
...
FindFirstVolumeMountPointA PROTO STDCALL :
DWORD,:
DWORD,:
    DWORD
    IFNDEF __UNICODE__
...
FindFirstVolumeMountPointW PROTO STDCALL :
DWORD,:
DWORD,:
    DWORD
    IFDEF __UNICODE__
...
FindFirstVolumeW PROTO STDCALL :
DWORD,:
    DWORD
    IFDEF __UNICODE__
...
FindNextChangeNotification PROTO STDCALL :
    DWORD

FindNextFileA PROTO STDCALL :
DWORD,:
    DWORD
    IFNDEF __UNICODE__
...
FindNextVolumeMountPointA PROTO STDCALL :
DWORD,:
DWORD,:
    DWORD
    IFNDEF __UNICODE__
...
FindNextVolumeMountPointW PROTO STDCALL :
DWORD,:
DWORD,:
    DWORD
    IFDEF __UNICODE__
...
FindVolumeClose PROTO STDCALL :
    DWORD
FindVolumeMountPointClose PROTO STDCALL :
    DWORD
FlushConsoleInputBuffer PROTO STDCALL :
    DWORD
FlushFileBuffers PROTO STDCALL :
    DWORD
FlushInstructionCache PROTO STDCALL :
DWORD,:
DWORD,:
    DWORD
FlushViewOfFile PROTO STDCALL :
DWORD,:
    DWORD

FoldStringA PROTO STDCALL :
DWORD,:
DWORD,:
DWORD,:
DWORD,:
...
FreeEnvironmentStringsA PROTO STDCALL :
    DWORD
    IFNDEF __UNICODE__
    FreeEnvironmentStrings equ <FreeEnvironmentStringsA>
    ENDIF

FreeEnvironmentStringsW PROTO STDCALL :
    DWORD
    IFDEF __UNICODE__
    FreeEnvironmentStrings equ <FreeEnvironmentStringsW>
    ENDIF

FreeLibrary PROTO STDCALL :
    DWORD
FreeLibraryAndExitThread PROTO STDCALL :
DWORD,:
    DWORD
FreeResource PROTO STDCALL :
    DWORD
FreeUserPhysicalPages PROTO STDCALL :
DWORD,:
DWORD,:
    DWORD
GenerateConsoleCtrlEvent PROTO STDCALL :
DWORD,:
    DWORD
    GetACP PROTO STDCALL

GetAtomNameA PROTO STDCALL :
DWORD,:
DWORD,:
    DWORD
    IFNDEF __UNICODE__
...
GetCPInfo PROTO STDCALL :
DWORD,:
    DWORD

GetCPInfoExA PROTO STDCALL :
DWORD,:
DWORD,:
    DWORD
    IFNDEF __UNICODE__
...
GetCalendarInfoA PROTO STDCALL :
DWORD,:
DWORD,:
DWORD,:
DWORD,:
...
GetCalendarInfoW PROTO STDCALL :
DWORD,:
DWORD,:
DWORD,:
DWORD,:
...
GetCommConfig PROTO STDCALL :
DWORD,:
DWORD,:
    DWORD
GetCommMask PROTO STDCALL :
DWORD,:
    DWORD
GetCommModemStatus PROTO STDCALL :
DWORD,:
    DWORD
GetCommProperties PROTO STDCALL :
DWORD,:
    DWORD
GetCommState PROTO STDCALL :
DWORD,:
    DWORD
GetCommTimeouts PROTO STDCALL :
DWORD,:
    DWORD
...
GetCompressedFileSizeA PROTO STDCALL :
DWORD,:
    DWORD
    IFNDEF __UNICODE__
...
GetCompressedFileSizeW PROTO STDCALL :
DWORD,:
    DWORD
    IFDEF __UNICODE__
...
GetComputerNameA PROTO STDCALL :
DWORD,:
    DWORD
    IFNDEF __UNICODE__
...
GetComputerNameExA PROTO STDCALL :
DWORD,:
DWORD,:
    DWORD
    IFNDEF __UNICODE__
...
GetComputerNameExW PROTO STDCALL :
DWORD,:
DWORD,:
    DWORD
    IFDEF __UNICODE__
...
GetComputerNameW PROTO STDCALL :
DWORD,:
    DWORD
    IFDEF __UNICODE__
...
GetConsoleCursorInfo PROTO STDCALL :
DWORD,:
    DWORD
GetConsoleDisplayMode PROTO STDCALL :
    DWORD
GetConsoleFontSize PROTO STDCALL :
DWORD,:
    DWORD
GetConsoleMode PROTO STDCALL :
DWORD,:
    DWORD
    GetConsoleOutputCP PROTO STDCALL
GetConsoleProcessList PROTO STDCALL :
DWORD,:
    DWORD
GetConsoleScreenBufferInfo PROTO STDCALL :
DWORD,:
    DWORD
GetConsoleSelectionInfo PROTO STDCALL :
    DWORD

GetConsoleTitleA PROTO STDCALL :
DWORD,:
    DWORD
    IFNDEF __UNICODE__
...
GetConsoleTitleW PROTO STDCALL :
DWORD,:
    DWORD
    IFDEF __UNICODE__
...
GetCurrencyFormatA PROTO STDCALL :
DWORD,:
DWORD,:
DWORD,:
DWORD,:
...
GetCurrencyFormatW PROTO STDCALL :
DWORD,:
DWORD,:
DWORD,:
DWORD,:
...
GetCurrentActCtx PROTO STDCALL :
    DWORD
GetCurrentConsoleFont PROTO STDCALL :
DWORD,:
DWORD,:
    DWORD

GetCurrentDirectoryA PROTO STDCALL :
DWORD,:
    DWORD
    IFNDEF __UNICODE__
...
GetCurrentDirectoryW PROTO STDCALL :
DWORD,:
    DWORD
    IFDEF __UNICODE__
...
GetDefaultCommConfigA PROTO STDCALL :
DWORD,:
DWORD,:
    DWORD
    IFNDEF __UNICODE__
...
GetDefaultCommConfigW PROTO STDCALL :
DWORD,:
DWORD,:
    DWORD
    IFDEF __UNICODE__
...
GetDevicePowerState PROTO STDCALL :
DWORD,:
    DWORD

GetDiskFreeSpaceA PROTO STDCALL :
DWORD,:
DWORD,:
DWORD,:
DWORD,:
...
GetDiskFreeSpaceExA PROTO STDCALL :
DWORD,:
DWORD,:
DWORD,:
    DWORD
...
GetDiskFreeSpaceExW PROTO STDCALL :
DWORD,:
DWORD,:
DWORD,:
    DWORD
...
GetDiskFreeSpaceW PROTO STDCALL :
DWORD,:
DWORD,:
DWORD,:
DWORD,:
...
GetDllDirectoryA PROTO STDCALL :
DWORD,:
    DWORD
    IFNDEF __UNICODE__
...
GetDllDirectoryW PROTO STDCALL :
DWORD,:
    DWORD
    IFDEF __UNICODE__
...
GetDriveTypeA PROTO STDCALL :
    DWORD
    IFNDEF __UNICODE__
    GetDriveType equ <GetDriveTypeA>
    ENDIF

GetDriveTypeW PROTO STDCALL :
    DWORD
    IFDEF __UNICODE__
...
GetEnvironmentVariableA PROTO STDCALL :
DWORD,:
DWORD,:
    DWORD
    IFNDEF __UNICODE__
...
GetEnvironmentVariableW PROTO STDCALL :
DWORD,:
DWORD,:
    DWORD
    IFDEF __UNICODE__
...
GetExitCodeProcess PROTO STDCALL :
DWORD,:
    DWORD
GetExitCodeThread PROTO STDCALL :
DWORD,:
    DWORD

GetFileAttributesA PROTO STDCALL :
    DWORD
    IFNDEF __UNICODE__
    GetFileAttributes equ <GetFileAttributesA>
    ENDIF

GetFileAttributesExA PROTO STDCALL :
DWORD,:
DWORD,:
    DWORD
    IFNDEF __UNICODE__
...
GetFileAttributesExW PROTO STDCALL :
DWORD,:
DWORD,:
    DWORD
    IFDEF __UNICODE__
...
GetFileAttributesW PROTO STDCALL :
    DWORD
    IFDEF __UNICODE__
    GetFileAttributes equ <GetFileAttributesW>
    ENDIF

GetFileInformationByHandle PROTO STDCALL :
DWORD,:
    DWORD
GetFileSize PROTO STDCALL :
DWORD,:
    DWORD
GetFileSizeEx PROTO STDCALL :
DWORD,:
    DWORD
GetFileTime PROTO STDCALL :
DWORD,:
DWORD,:
DWORD,:
    DWORD
GetFileType PROTO STDCALL :
    DWORD

GetFirmwareEnvironmentVariableA PROTO STDCALL :
DWORD,:
DWORD,:
DWORD,:
    DWORD
...
GetFirmwareEnvironmentVariableW PROTO STDCALL :
DWORD,:
DWORD,:
DWORD,:
    DWORD
...
GetFullPathNameA PROTO STDCALL :
DWORD,:
DWORD,:
DWORD,:
    DWORD
...
GetFullPathNameW PROTO STDCALL :
DWORD,:
DWORD,:
DWORD,:
    DWORD
...
GetHandleInformation PROTO STDCALL :
DWORD,:
    DWORD
GetLargestConsoleWindowSize PROTO STDCALL :
    DWORD
    GetLastError PROTO STDCALL
GetLocalTime PROTO STDCALL :
    DWORD

GetLocaleInfoA PROTO STDCALL :
DWORD,:
DWORD,:
DWORD,:
    DWORD
...
GetLogicalDriveStringsA PROTO STDCALL :
DWORD,:
    DWORD
    IFNDEF __UNICODE__
...
GetLogicalDriveStringsW PROTO STDCALL :
DWORD,:
    DWORD
    IFDEF __UNICODE__
...
GetLongPathNameA PROTO STDCALL :
DWORD,:
DWORD,:
    DWORD
    IFNDEF __UNICODE__
...
GetLongPathNameW PROTO STDCALL :
DWORD,:
DWORD,:
    DWORD
    IFDEF __UNICODE__
...
GetModuleFileNameA PROTO STDCALL :
DWORD,:
DWORD,:
    DWORD
    IFNDEF __UNICODE__
...
GetModuleFileNameW PROTO STDCALL :
DWORD,:
DWORD,:
    DWORD
    IFDEF __UNICODE__
...
GetModuleHandleA PROTO STDCALL :
    DWORD
    IFNDEF __UNICODE__
    GetModuleHandle equ <GetModuleHandleA>
    ENDIF

GetModuleHandleExA PROTO STDCALL :
DWORD,:
DWORD,:
    DWORD
    IFNDEF __UNICODE__
...
GetModuleHandleExW PROTO STDCALL :
DWORD,:
DWORD,:
    DWORD
    IFDEF __UNICODE__
...
GetNamedPipeHandleStateA PROTO STDCALL :
DWORD,:
DWORD,:
DWORD,:
DWORD,:
...
GetNamedPipeHandleStateW PROTO STDCALL :
DWORD,:
DWORD,:
DWORD,:
DWORD,:
...
GetNamedPipeInfo PROTO STDCALL :
DWORD,:
DWORD,:
DWORD,:
DWORD,:
    DWORD
GetNativeSystemInfo PROTO STDCALL :
    DWORD
GetNumaAvailableMemory PROTO STDCALL :
DWORD,:
DWORD,:
    DWORD
GetNumaAvailableMemoryNode PROTO STDCALL :
DWORD,:
    DWORD
GetNumaHighestNodeNumber PROTO STDCALL :
    DWORD
GetNumaNodeProcessorMask PROTO STDCALL :
DWORD,:
    DWORD
GetNumaProcessorMap PROTO STDCALL :
DWORD,:
DWORD,:
    DWORD
GetNumaProcessorNode PROTO STDCALL :
DWORD,:
    DWORD

GetNumberFormatA PROTO STDCALL :
DWORD,:
DWORD,:
DWORD,:
DWORD,:
...
GetNumberFormatW PROTO STDCALL :
DWORD,:
DWORD,:
DWORD,:
DWORD,:
...
GetNumberOfConsoleInputEvents PROTO STDCALL :
DWORD,:
    DWORD
GetNumberOfConsoleMouseButtons PROTO STDCALL :
    DWORD
    GetOEMCP PROTO STDCALL
GetOverlappedResult PROTO STDCALL :
DWORD,:
DWORD,:
DWORD,:
    DWORD
GetPriorityClass PROTO STDCALL :
    DWORD

GetPrivateProfileIntA PROTO STDCALL :
DWORD,:
DWORD,:
DWORD,:
    DWORD
...
GetPrivateProfileIntW PROTO STDCALL :
DWORD,:
DWORD,:
DWORD,:
    DWORD
...
GetPrivateProfileSectionA PROTO STDCALL :
DWORD,:
DWORD,:
DWORD,:
    DWORD
...
GetPrivateProfileSectionNamesA PROTO STDCALL :
DWORD,:
DWORD,:
    DWORD
    IFNDEF __UNICODE__
...
GetPrivateProfileSectionNamesW PROTO STDCALL :
DWORD,:
DWORD,:
    DWORD
    IFDEF __UNICODE__
...
GetPrivateProfileSectionW PROTO STDCALL :
DWORD,:
DWORD,:
DWORD,:
    DWORD
...
GetPrivateProfileStringA PROTO STDCALL :
DWORD,:
DWORD,:
DWORD,:
DWORD,:
...
GetPrivateProfileStringW PROTO STDCALL :
DWORD,:
DWORD,:
DWORD,:
DWORD,:
...
GetPrivateProfileStructA PROTO STDCALL :
DWORD,:
DWORD,:
DWORD,:
DWORD,:
...
GetPrivateProfileStructW PROTO STDCALL :
DWORD,:
DWORD,:
DWORD,:
DWORD,:
...
GetProcAddress PROTO STDCALL :
DWORD,:
    DWORD
GetProcessAffinityMask PROTO STDCALL :
DWORD,:
DWORD,:
    DWORD
GetProcessHandleCount PROTO STDCALL :
DWORD,:
    DWORD
    GetProcessHeap PROTO STDCALL
GetProcessHeaps PROTO STDCALL :
DWORD,:
    DWORD
GetProcessId PROTO STDCALL :
    DWORD
GetProcessIoCounters PROTO STDCALL :
DWORD,:
    DWORD
GetProcessPriorityBoost PROTO STDCALL :
DWORD,:
    DWORD
GetProcessShutdownParameters PROTO STDCALL :
DWORD,:
    DWORD
GetProcessTimes PROTO STDCALL :
DWORD,:
DWORD,:
DWORD,:
DWORD,:
    DWORD
GetProcessVersion PROTO STDCALL :
    DWORD
GetProcessWorkingSetSize PROTO STDCALL :
DWORD,:
DWORD,:
    DWORD

GetProfileIntA PROTO STDCALL :
DWORD,:
DWORD,:
    DWORD
    IFNDEF __UNICODE__
...
GetProfileSectionA PROTO STDCALL :
DWORD,:
DWORD,:
    DWORD
    IFNDEF __UNICODE__
...
GetProfileSectionW PROTO STDCALL :
DWORD,:
DWORD,:
    DWORD
    IFDEF __UNICODE__
...
GetProfileStringA PROTO STDCALL :
DWORD,:
DWORD,:
DWORD,:
DWORD,:
...
GetProfileStringW PROTO STDCALL :
DWORD,:
DWORD,:
DWORD,:
DWORD,:
...
GetQueuedCompletionStatus PROTO STDCALL :
DWORD,:
DWORD,:
DWORD,:
DWORD,:
...
GetShortPathNameA PROTO STDCALL :
DWORD,:
DWORD,:
    DWORD
    IFNDEF __UNICODE__
...
GetShortPathNameW PROTO STDCALL :
DWORD,:
DWORD,:
    DWORD
    IFDEF __UNICODE__
...
GetStartupInfoA PROTO STDCALL :
    DWORD
    IFNDEF __UNICODE__
    GetStartupInfo equ <GetStartupInfoA>
    ENDIF

GetStartupInfoW PROTO STDCALL :
    DWORD
    IFDEF __UNICODE__
    GetStartupInfo equ <GetStartupInfoW>
    ENDIF

GetStdHandle PROTO STDCALL :
    DWORD

GetStringTypeA PROTO STDCALL :
DWORD,:
DWORD,:
DWORD,:
DWORD,:
...
GetStringTypeExA PROTO STDCALL :
DWORD,:
DWORD,:
DWORD,:
DWORD,:
...
GetStringTypeExW PROTO STDCALL :
DWORD,:
DWORD,:
DWORD,:
DWORD,:
...
GetSystemDirectoryA PROTO STDCALL :
DWORD,:
    DWORD
    IFNDEF __UNICODE__
...
GetSystemDirectoryW PROTO STDCALL :
DWORD,:
    DWORD
    IFDEF __UNICODE__
...
GetSystemInfo PROTO STDCALL :
    DWORD
GetSystemPowerStatus PROTO STDCALL :
    DWORD
GetSystemRegistryQuota PROTO STDCALL :
DWORD,:
    DWORD
GetSystemTime PROTO STDCALL :
    DWORD
GetSystemTimeAdjustment PROTO STDCALL :
DWORD,:
DWORD,:
    DWORD
GetSystemTimeAsFileTime PROTO STDCALL :
    DWORD
GetSystemTimes PROTO STDCALL :
DWORD,:
DWORD,:
    DWORD

GetSystemWindowsDirectoryA PROTO STDCALL :
DWORD,:
    DWORD
    IFNDEF __UNICODE__
...
GetSystemWindowsDirectoryW PROTO STDCALL :
DWORD,:
    DWORD
    IFDEF __UNICODE__
...
GetSystemWow64DirectoryA PROTO STDCALL :
DWORD,:
    DWORD
    IFNDEF __UNICODE__
...
GetSystemWow64DirectoryW PROTO STDCALL :
DWORD,:
    DWORD
    IFDEF __UNICODE__
...
GetTapeParameters PROTO STDCALL :
DWORD,:
DWORD,:
DWORD,:
    DWORD
GetTapePosition PROTO STDCALL :
DWORD,:
DWORD,:
DWORD,:
DWORD,:
    DWORD
GetTapeStatus PROTO STDCALL :
    DWORD

GetTempFileNameA PROTO STDCALL :
DWORD,:
DWORD,:
DWORD,:
    DWORD
...
GetTempFileNameW PROTO STDCALL :
DWORD,:
DWORD,:
DWORD,:
    DWORD
...
GetThreadContext PROTO STDCALL :
DWORD,:
    DWORD
GetThreadIOPendingFlag PROTO STDCALL :
DWORD,:
    DWORD
    GetThreadLocale PROTO STDCALL
GetThreadPriority PROTO STDCALL :
    DWORD
GetThreadPriorityBoost PROTO STDCALL :
DWORD,:
    DWORD
GetThreadSelectorEntry PROTO STDCALL :
DWORD,:
DWORD,:
    DWORD
GetThreadTimes PROTO STDCALL :
DWORD,:
DWORD,:
DWORD,:
DWORD,:
...
GetVolumeInformationW PROTO STDCALL :
DWORD,:
DWORD,:
DWORD,:
DWORD,:
...
GetVolumeNameForVolumeMountPointA PROTO STDCALL :
DWORD,:
DWORD,:
    DWORD
    IFNDEF __UNICODE__
...
GetVolumeNameForVolumeMountPointW PROTO STDCALL :
DWORD,:
DWORD,:
    DWORD
    IFDEF __UNICODE__
...
GetVolumePathNameA PROTO STDCALL :
DWORD,:
DWORD,:
    DWORD
    IFNDEF __UNICODE__
...
GetVolumePathNameW PROTO STDCALL :
DWORD,:
DWORD,:
    DWORD
    IFDEF __UNICODE__
...
GetVolumePathNamesForVolumeNameA PROTO STDCALL :
DWORD,:
DWORD,:
DWORD,:
    DWORD
...
GetVolumePathNamesForVolumeNameW PROTO STDCALL :
DWORD,:
DWORD,:
DWORD,:
    DWORD
...
GetWindowsDirectoryA PROTO STDCALL :
DWORD,:
    DWORD
    IFNDEF __UNICODE__
...
GetWindowsDirectoryW PROTO STDCALL :
DWORD,:
    DWORD
    IFDEF __UNICODE__
...
GlobalAddAtomA PROTO STDCALL :
    DWORD
    IFNDEF __UNICODE__
    GlobalAddAtom equ <GlobalAddAtomA>
    ENDIF

GlobalAddAtomW PROTO STDCALL :
    DWORD
    IFDEF __UNICODE__
    GlobalAddAtom equ <GlobalAddAtomW>
    ENDIF

GlobalAlloc PROTO STDCALL :
DWORD,:
    DWORD
GlobalCompact PROTO STDCALL :
    DWORD
GlobalDeleteAtom PROTO STDCALL :
    DWORD

GlobalFindAtomA PROTO STDCALL :
    DWORD
    IFNDEF __UNICODE__
    GlobalFindAtom equ <GlobalFindAtomA>
    ENDIF

GlobalFindAtomW PROTO STDCALL :
    DWORD
    IFDEF __UNICODE__
    GlobalFindAtom equ <GlobalFindAtomW>
    ENDIF

GlobalFix PROTO STDCALL :
    DWORD
GlobalFlags PROTO STDCALL :
    DWORD
GlobalFree PROTO STDCALL :
    DWORD

GlobalGetAtomNameA PROTO STDCALL :
DWORD,:
DWORD,:
    DWORD
    IFNDEF __UNICODE__
...
GlobalGetAtomNameW PROTO STDCALL :
DWORD,:
DWORD,:
    DWORD
    IFDEF __UNICODE__
...
GlobalHandle PROTO STDCALL :
    DWORD
GlobalLock PROTO STDCALL :
    DWORD
GlobalMemoryStatus PROTO STDCALL :
    DWORD
GlobalMemoryStatusEx PROTO STDCALL :
    DWORD
GlobalReAlloc PROTO STDCALL :
DWORD,:
DWORD,:
    DWORD
GlobalSize PROTO STDCALL :
    DWORD
GlobalUnWire PROTO STDCALL :
    DWORD
GlobalUnfix PROTO STDCALL :
    DWORD
GlobalUnlock PROTO STDCALL :
    DWORD
GlobalWire PROTO STDCALL :
    DWORD
Heap32First PROTO STDCALL :
DWORD,:
DWORD,:
    DWORD
Heap32ListFirst PROTO STDCALL :
DWORD,:
    DWORD
Heap32ListNext PROTO STDCALL :
DWORD,:
    DWORD
Heap32Next PROTO STDCALL :
    DWORD
HeapAlloc PROTO STDCALL :
DWORD,:
DWORD,:
    DWORD
HeapCompact PROTO STDCALL :
DWORD,:
    DWORD
...
DWORD,:
    DWORD
HeapLock PROTO STDCALL :
    DWORD
HeapQueryInformation PROTO STDCALL :
DWORD,:
DWORD,:
DWORD,:
DWORD,:
...
DWORD,:
    DWORD
HeapSetInformation PROTO STDCALL :
DWORD,:
DWORD,:
DWORD,:
    DWORD
HeapSize PROTO STDCALL :
DWORD,:
DWORD,:
    DWORD
HeapUnlock PROTO STDCALL :
    DWORD
HeapValidate PROTO STDCALL :
DWORD,:
DWORD,:
    DWORD
HeapWalk PROTO STDCALL :
DWORD,:
    DWORD
InitAtomTable PROTO STDCALL :
    DWORD
InitializeCriticalSection PROTO STDCALL :
    DWORD
InitializeCriticalSectionAndSpinCount PROTO STDCALL :
DWORD,:
    DWORD
InitializeSListHead PROTO STDCALL :
    DWORD
InterlockedCompareExchange PROTO STDCALL :
DWORD,:
DWORD,:
    DWORD
InterlockedDecrement PROTO STDCALL :
    DWORD
InterlockedExchange PROTO STDCALL :
DWORD,:
    DWORD
InterlockedExchangeAdd PROTO STDCALL :
DWORD,:
    DWORD
InterlockedFlushSList PROTO STDCALL :
    DWORD
InterlockedIncrement PROTO STDCALL :
    DWORD
InterlockedPopEntrySList PROTO STDCALL :
    DWORD
InterlockedPushEntrySList PROTO STDCALL :
DWORD,:
    DWORD
IsBadCodePtr PROTO STDCALL :
    DWORD
IsBadHugeReadPtr PROTO STDCALL :
DWORD,:
    DWORD
IsBadHugeWritePtr PROTO STDCALL :
DWORD,:
    DWORD
IsBadReadPtr PROTO STDCALL :
DWORD,:
    DWORD

IsBadStringPtrA PROTO STDCALL :
DWORD,:
    DWORD
    IFNDEF __UNICODE__
...
IsBadWritePtr PROTO STDCALL :
DWORD,:
    DWORD
IsDBCSLeadByte PROTO STDCALL :
    DWORD
IsDBCSLeadByteEx PROTO STDCALL :
DWORD,:
    DWORD
    IsDebuggerPresent PROTO STDCALL
IsProcessInJob PROTO STDCALL :
DWORD,:
DWORD,:
    DWORD
IsProcessorFeaturePresent PROTO STDCALL :
    DWORD
    IsSystemResumeAutomatic PROTO STDCALL
IsValidCodePage PROTO STDCALL :
    DWORD
IsValidLanguageGroup PROTO STDCALL :
DWORD,:
    DWORD
IsValidLocale PROTO STDCALL :
DWORD,:
    DWORD
IsWow64Process PROTO STDCALL :
DWORD,:
    DWORD

LCMapStringA PROTO STDCALL :
DWORD,:
DWORD,:
DWORD,:
DWORD,:
...
LeaveCriticalSection PROTO STDCALL :
    DWORD

LoadLibraryA PROTO STDCALL :
    DWORD
    IFNDEF __UNICODE__
    LoadLibrary equ <LoadLibraryA>
    ENDIF

LoadLibraryExA PROTO STDCALL :
DWORD,:
DWORD,:
    DWORD
    IFNDEF __UNICODE__
...
LoadLibraryW PROTO STDCALL :
    DWORD
    IFDEF __UNICODE__
    LoadLibrary equ <LoadLibraryW>
    ENDIF

LoadModule PROTO STDCALL :
DWORD,:
    DWORD
LoadResource PROTO STDCALL :
DWORD,:
    DWORD
LocalAlloc PROTO STDCALL :
DWORD,:
    DWORD
LocalCompact PROTO STDCALL :
    DWORD
LocalFileTimeToFileTime PROTO STDCALL :
DWORD,:
    DWORD
LocalFlags PROTO STDCALL :
    DWORD
LocalFree PROTO STDCALL :
    DWORD
LocalHandle PROTO STDCALL :
    DWORD
LocalLock PROTO STDCALL :
    DWORD
LocalReAlloc PROTO STDCALL :
DWORD,:
DWORD,:
    DWORD
LocalShrink PROTO STDCALL :
DWORD,:
    DWORD
LocalSize PROTO STDCALL :
    DWORD
LocalUnlock PROTO STDCALL :
    DWORD
LockFile PROTO STDCALL :
DWORD,:
DWORD,:
DWORD,:
DWORD,:
    DWORD
LockFileEx PROTO STDCALL :
DWORD,:
DWORD,:
DWORD,:
DWORD,:
DWORD,:
    DWORD
LockResource PROTO STDCALL :
    DWORD
MapUserPhysicalPages PROTO STDCALL :
DWORD,:
DWORD,:
    DWORD
MapUserPhysicalPagesScatter PROTO STDCALL :
DWORD,:
DWORD,:
    DWORD
MapViewOfFile PROTO STDCALL :
DWORD,:
DWORD,:
DWORD,:
DWORD,:
    DWORD
MapViewOfFileEx PROTO STDCALL :
DWORD,:
DWORD,:
DWORD,:
DWORD,:
...
MoveFileWithProgressA PROTO STDCALL :
DWORD,:
DWORD,:
DWORD,:
DWORD,:
...
MoveFileWithProgressW PROTO STDCALL :
DWORD,:
DWORD,:
DWORD,:
DWORD,:
...
MulDiv PROTO STDCALL :
DWORD,:
DWORD,:
    DWORD
MultiByteToWideChar PROTO STDCALL :
DWORD,:
DWORD,:
DWORD,:
DWORD,:
DWORD,:
    DWORD
NumaVirtualQueryNode PROTO STDCALL :
DWORD,:
DWORD,:
DWORD,:
    DWORD

OpenEventA PROTO STDCALL :
DWORD,:
DWORD,:
    DWORD
    IFNDEF __UNICODE__
...
OpenFile PROTO STDCALL :
DWORD,:
DWORD,:
    DWORD

OpenFileMappingA PROTO STDCALL :
DWORD,:
DWORD,:
    DWORD
    IFNDEF __UNICODE__
...
OpenFileMappingW PROTO STDCALL :
DWORD,:
DWORD,:
    DWORD
    IFDEF __UNICODE__
...
OpenProcess PROTO STDCALL :
DWORD,:
DWORD,:
    DWORD

OpenSemaphoreA PROTO STDCALL :
DWORD,:
DWORD,:
    DWORD
    IFNDEF __UNICODE__
...
OpenThread PROTO STDCALL :
DWORD,:
DWORD,:
    DWORD

OpenWaitableTimerA PROTO STDCALL :
DWORD,:
DWORD,:
    DWORD
    IFNDEF __UNICODE__
...
OpenWaitableTimerW PROTO STDCALL :
DWORD,:
DWORD,:
    DWORD
    IFDEF __UNICODE__
...
OutputDebugStringA PROTO STDCALL :
    DWORD
    IFNDEF __UNICODE__
    OutputDebugString equ <OutputDebugStringA>
    ENDIF

OutputDebugStringW PROTO STDCALL :
    DWORD
    IFDEF __UNICODE__
    OutputDebugString equ <OutputDebugStringW>
    ENDIF

PeekConsoleInputA PROTO STDCALL :
DWORD,:
DWORD,:
DWORD,:
    DWORD
...
PeekConsoleInputW PROTO STDCALL :
DWORD,:
DWORD,:
DWORD,:
    DWORD
...
DWORD,:
    DWORD
PostQueuedCompletionStatus PROTO STDCALL :
DWORD,:
DWORD,:
DWORD,:
    DWORD
PrepareTape PROTO STDCALL :
DWORD,:
DWORD,:
    DWORD

Process32FirstW PROTO STDCALL :
DWORD,:
    DWORD
    IFDEF __UNICODE__
...
ProcessIdToSessionId PROTO STDCALL :
DWORD,:
    DWORD
PulseEvent PROTO STDCALL :
    DWORD
PurgeComm PROTO STDCALL :
DWORD,:
    DWORD

QueryActCtxW PROTO STDCALL :
DWORD,:
DWORD,:
DWORD,:
DWORD,:
...
QueryDepthSList PROTO STDCALL :
    DWORD

QueryDosDeviceA PROTO STDCALL :
DWORD,:
DWORD,:
    DWORD
    IFNDEF __UNICODE__
...
QueryInformationJobObject PROTO STDCALL :
DWORD,:
DWORD,:
DWORD,:
DWORD,:
    DWORD
QueryMemoryResourceNotification PROTO STDCALL :
DWORD,:
    DWORD
...
QueryPerformanceFrequency PROTO STDCALL :
    DWORD
QueueUserAPC PROTO STDCALL :
DWORD,:
DWORD,:
    DWORD
QueueUserWorkItem PROTO STDCALL :
DWORD,:
DWORD,:
    DWORD
RaiseException PROTO STDCALL :
DWORD,:
DWORD,:
DWORD,:
    DWORD

ReadConsoleA PROTO STDCALL :
DWORD,:
DWORD,:
DWORD,:
DWORD,:
...
ReadConsoleInputA PROTO STDCALL :
DWORD,:
DWORD,:
DWORD,:
    DWORD
...
ReadConsoleInputW PROTO STDCALL :
DWORD,:
DWORD,:
DWORD,:
    DWORD
...
ReadConsoleOutputA PROTO STDCALL :
DWORD,:
DWORD,:
DWORD,:
DWORD,:
...
ReadConsoleOutputAttribute PROTO STDCALL :
DWORD,:
DWORD,:
DWORD,:
DWORD,:
...
ReadConsoleOutputCharacterA PROTO STDCALL :
DWORD,:
DWORD,:
DWORD,:
DWORD,:
...
ReadConsoleOutputCharacterW PROTO STDCALL :
DWORD,:
DWORD,:
DWORD,:
DWORD,:
...
ReadConsoleOutputW PROTO STDCALL :
DWORD,:
DWORD,:
DWORD,:
DWORD,:
...
ReadDirectoryChangesW PROTO STDCALL :
DWORD,:
DWORD,:
DWORD,:
DWORD,:
...
DWORD,:
    DWORD
ReadFileEx PROTO STDCALL :
DWORD,:
DWORD,:
DWORD,:
DWORD,:
    DWORD
ReadFileScatter PROTO STDCALL :
DWORD,:
DWORD,:
DWORD,:
DWORD,:
    DWORD
ReadProcessMemory PROTO STDCALL :
DWORD,:
DWORD,:
DWORD,:
DWORD,:
    DWORD
RegisterWaitForSingleObject PROTO STDCALL :
DWORD,:
DWORD,:
DWORD,:
DWORD,:
DWORD,:
    DWORD
RegisterWaitForSingleObjectEx PROTO STDCALL :
DWORD,:
DWORD,:
DWORD,:
DWORD,:
    DWORD
ReleaseActCtx PROTO STDCALL :
    DWORD
ReleaseMutex PROTO STDCALL :
    DWORD
ReleaseSemaphore PROTO STDCALL :
DWORD,:
DWORD,:
    DWORD

RemoveDirectoryA PROTO STDCALL :
    DWORD
    IFNDEF __UNICODE__
    RemoveDirectory equ <RemoveDirectoryA>
    ENDIF

RemoveDirectoryW PROTO STDCALL :
    DWORD
    IFDEF __UNICODE__
    RemoveDirectory equ <RemoveDirectoryW>
    ENDIF

RemoveLocalAlternateComputerNameA PROTO STDCALL :
DWORD,:
    DWORD
    IFNDEF __UNICODE__
...
RemoveLocalAlternateComputerNameW PROTO STDCALL :
DWORD,:
    DWORD
    IFDEF __UNICODE__
...
RemoveVectoredExceptionHandler PROTO STDCALL :
    DWORD

ReplaceFileA PROTO STDCALL :
DWORD,:
DWORD,:
DWORD,:
DWORD,:
...
RequestDeviceWakeup PROTO STDCALL :
    DWORD
RequestWakeupLatency PROTO STDCALL :
    DWORD
ResetEvent PROTO STDCALL :
    DWORD
ResetWriteWatch PROTO STDCALL :
DWORD,:
    DWORD
RestoreLastError PROTO STDCALL :
    DWORD
ResumeThread PROTO STDCALL :
    DWORD
RtlCaptureContext PROTO STDCALL :
    DWORD
RtlCaptureStackBackTrace PROTO STDCALL :
DWORD,:
DWORD,:
DWORD,:
    DWORD
RtlFillMemory PROTO STDCALL :
DWORD,:
DWORD,:
    DWORD
RtlMoveMemory PROTO STDCALL :
DWORD,:
DWORD,:
    DWORD
RtlUnwind PROTO STDCALL :
DWORD,:
DWORD,:
DWORD,:
    DWORD
RtlZeroMemory PROTO STDCALL :
DWORD,:
    DWORD

ScrollConsoleScreenBufferA PROTO STDCALL :
DWORD,:
DWORD,:
DWORD,:
DWORD,:
...
ScrollConsoleScreenBufferW PROTO STDCALL :
DWORD,:
DWORD,:
DWORD,:
DWORD,:
...
SetCalendarInfoA PROTO STDCALL :
DWORD,:
DWORD,:
DWORD,:
    DWORD
...
SetCalendarInfoW PROTO STDCALL :
DWORD,:
DWORD,:
DWORD,:
    DWORD
...
SetCommBreak PROTO STDCALL :
    DWORD
SetCommConfig PROTO STDCALL :
DWORD,:
DWORD,:
    DWORD
SetCommMask PROTO STDCALL :
DWORD,:
    DWORD
SetCommState PROTO STDCALL :
DWORD,:
    DWORD
SetCommTimeouts PROTO STDCALL :
DWORD,:
    DWORD

SetComputerNameA PROTO STDCALL :
    DWORD
    IFNDEF __UNICODE__
    SetComputerName equ <SetComputerNameA>
    ENDIF

SetComputerNameExA PROTO STDCALL :
DWORD,:
    DWORD
    IFNDEF __UNICODE__
...
SetComputerNameExW PROTO STDCALL :
DWORD,:
    DWORD
    IFDEF __UNICODE__
...
SetComputerNameW PROTO STDCALL :
    DWORD
    IFDEF __UNICODE__
...
SetConsoleActiveScreenBuffer PROTO STDCALL :
    DWORD
SetConsoleCP PROTO STDCALL :
    DWORD
SetConsoleCtrlHandler PROTO STDCALL :
DWORD,:
    DWORD
SetConsoleCursor PROTO STDCALL :
DWORD,:
    DWORD
SetConsoleCursorInfo PROTO STDCALL :
DWORD,:
    DWORD
SetConsoleCursorPosition PROTO STDCALL :
DWORD,:
    DWORD
SetConsoleMode PROTO STDCALL :
DWORD,:
    DWORD
SetConsoleOutputCP PROTO STDCALL :
    DWORD
SetConsoleScreenBufferSize PROTO STDCALL :
DWORD,:
    DWORD
SetConsoleTextAttribute PROTO STDCALL :
DWORD,:
    DWORD

SetConsoleTitleA PROTO STDCALL :
    DWORD
    IFNDEF __UNICODE__
    SetConsoleTitle equ <SetConsoleTitleA>
    ENDIF

SetConsoleTitleW PROTO STDCALL :
    DWORD
    IFDEF __UNICODE__
    SetConsoleTitle equ <SetConsoleTitleW>
    ENDIF

SetConsoleWindowInfo PROTO STDCALL :
DWORD,:
DWORD,:
    DWORD
SetCriticalSectionSpinCount PROTO STDCALL :
DWORD,:
    DWORD

SetCurrentDirectoryA PROTO STDCALL :
    DWORD
    IFNDEF __UNICODE__
    SetCurrentDirectory equ <SetCurrentDirectoryA>
    ENDIF

SetCurrentDirectoryW PROTO STDCALL :
    DWORD
    IFDEF __UNICODE__
    SetCurrentDirectory equ <SetCurrentDirectoryW>
    ENDIF

SetDefaultCommConfigA PROTO STDCALL :
DWORD,:
DWORD,:
    DWORD
    IFNDEF __UNICODE__
...
SetDefaultCommConfigW PROTO STDCALL :
DWORD,:
DWORD,:
    DWORD
    IFDEF __UNICODE__
...
SetDllDirectoryA PROTO STDCALL :
    DWORD
    IFNDEF __UNICODE__
    SetDllDirectory equ <SetDllDirectoryA>
    ENDIF

SetDllDirectoryW PROTO STDCALL :
    DWORD
    IFDEF __UNICODE__
    SetDllDirectory equ <SetDllDirectoryW>
    ENDIF

SetEndOfFile PROTO STDCALL :
    DWORD

SetEnvironmentVariableA PROTO STDCALL :
DWORD,:
    DWORD
    IFNDEF __UNICODE__
...
SetEnvironmentVariableW PROTO STDCALL :
DWORD,:
    DWORD
    IFDEF __UNICODE__
...
SetFileAttributesA PROTO STDCALL :
DWORD,:
    DWORD
    IFNDEF __UNICODE__
...
SetFileAttributesW PROTO STDCALL :
DWORD,:
    DWORD
    IFDEF __UNICODE__
...
SetFilePointer PROTO STDCALL :
DWORD,:
DWORD,:
DWORD,:
    DWORD
SetFilePointerEx PROTO STDCALL :
DWORD,:
DWORD,:
DWORD,:
DWORD,:
...
SetFileShortNameA PROTO STDCALL :
DWORD,:
    DWORD
    IFNDEF __UNICODE__
...
SetFileShortNameW PROTO STDCALL :
DWORD,:
    DWORD
    IFDEF __UNICODE__
...
SetFileTime PROTO STDCALL :
DWORD,:
DWORD,:
DWORD,:
    DWORD
SetFileValidData PROTO STDCALL :
DWORD,:
DWORD,:
    DWORD

SetFirmwareEnvironmentVariableA PROTO STDCALL :
DWORD,:
DWORD,:
DWORD,:
    DWORD
...
SetFirmwareEnvironmentVariableW PROTO STDCALL :
DWORD,:
DWORD,:
DWORD,:
    DWORD
...
SetHandleCount PROTO STDCALL :
    DWORD
SetHandleInformation PROTO STDCALL :
DWORD,:
DWORD,:
    DWORD
SetInformationJobObject PROTO STDCALL :
DWORD,:
DWORD,:
DWORD,:
    DWORD
SetLastError PROTO STDCALL :
    DWORD

SetLocalPrimaryComputerNameA PROTO STDCALL :
DWORD,:
    DWORD
    IFNDEF __UNICODE__
...
SetLocalPrimaryComputerNameW PROTO STDCALL :
DWORD,:
    DWORD
    IFDEF __UNICODE__
...
SetLocalTime PROTO STDCALL :
    DWORD

SetLocaleInfoA PROTO STDCALL :
DWORD,:
DWORD,:
    DWORD
    IFNDEF __UNICODE__
...
SetMailslotInfo PROTO STDCALL :
DWORD,:
    DWORD
SetMessageWaitingIndicator PROTO STDCALL :
DWORD,:
    DWORD
SetNamedPipeHandleState PROTO STDCALL :
DWORD,:
DWORD,:
DWORD,:
    DWORD
...
DWORD,:
    DWORD
SetProcessAffinityMask PROTO STDCALL :
DWORD,:
    DWORD
SetProcessPriorityBoost PROTO STDCALL :
DWORD,:
    DWORD
SetProcessShutdownParameters PROTO STDCALL :
DWORD,:
    DWORD
SetProcessWorkingSetSize PROTO STDCALL :
DWORD,:
DWORD,:
    DWORD
SetStdHandle PROTO STDCALL :
DWORD,:
    DWORD
SetSystemPowerState PROTO STDCALL :
DWORD,:
    DWORD
SetSystemTime PROTO STDCALL :
    DWORD
SetSystemTimeAdjustment PROTO STDCALL :
DWORD,:
    DWORD
SetTapeParameters PROTO STDCALL :
DWORD,:
DWORD,:
    DWORD
SetTapePosition PROTO STDCALL :
DWORD,:
DWORD,:
DWORD,:
DWORD,:
DWORD,:
    DWORD
SetThreadAffinityMask PROTO STDCALL :
DWORD,:
    DWORD
SetThreadContext PROTO STDCALL :
DWORD,:
    DWORD
SetThreadExecutionState PROTO STDCALL :
    DWORD
SetThreadIdealProcessor PROTO STDCALL :
DWORD,:
    DWORD
SetThreadLocale PROTO STDCALL :
    DWORD
SetThreadPriority PROTO STDCALL :
DWORD,:
    DWORD
SetThreadPriorityBoost PROTO STDCALL :
DWORD,:
    DWORD
SetTimeZoneInformation PROTO STDCALL :
    DWORD
SetTimerQueueTimer PROTO STDCALL :
DWORD,:
DWORD,:
DWORD,:
DWORD,:
DWORD,:
    DWORD
SetUnhandledExceptionFilter PROTO STDCALL :
    DWORD
SetUserGeoID PROTO STDCALL :
    DWORD

SetVolumeLabelA PROTO STDCALL :
DWORD,:
    DWORD
    IFNDEF __UNICODE__
...
SetVolumeMountPointA PROTO STDCALL :
DWORD,:
    DWORD
    IFNDEF __UNICODE__
...
SetVolumeMountPointW PROTO STDCALL :
DWORD,:
    DWORD
    IFDEF __UNICODE__
...
SetWaitableTimer PROTO STDCALL :
DWORD,:
DWORD,:
DWORD,:
DWORD,:
DWORD,:
    DWORD
SetupComm PROTO STDCALL :
DWORD,:
DWORD,:
    DWORD
SignalObjectAndWait PROTO STDCALL :
DWORD,:
DWORD,:
DWORD,:
    DWORD
SizeofResource PROTO STDCALL :
DWORD,:
    DWORD
Sleep PROTO STDCALL :
    DWORD
...
DWORD,:
    DWORD
SuspendThread PROTO STDCALL :
    DWORD
SwitchToFiber PROTO STDCALL :
    DWORD
    SwitchToThread PROTO STDCALL
SystemTimeToFileTime PROTO STDCALL :
DWORD,:
    DWORD
SystemTimeToTzSpecificLocalTime PROTO STDCALL :
DWORD,:
DWORD,:
    DWORD
TerminateJobObject PROTO STDCALL :
DWORD,:
    DWORD
TerminateProcess PROTO STDCALL :
DWORD,:
    DWORD
TerminateThread PROTO STDCALL :
DWORD,:
    DWORD
Thread32First PROTO STDCALL :
DWORD,:
    DWORD
Thread32Next PROTO STDCALL :
DWORD,:
    DWORD
    TlsAlloc PROTO STDCALL
TlsFree PROTO STDCALL :
    DWORD
TlsGetValue PROTO STDCALL :
    DWORD
TlsSetValue PROTO STDCALL :
DWORD,:
    DWORD
Toolhelp32ReadProcessMemory PROTO STDCALL :
DWORD,:
DWORD,:
DWORD,:
DWORD,:
    DWORD
TransactNamedPipe PROTO STDCALL :
DWORD,:
DWORD,:
DWORD,:
DWORD,:
...
DWORD,:
    DWORD
TransmitCommChar PROTO STDCALL :
DWORD,:
    DWORD
TryEnterCriticalSection PROTO STDCALL :
    DWORD
TzSpecificLocalTimeToSystemTime PROTO STDCALL :
DWORD,:
DWORD,:
    DWORD
UnhandledExceptionFilter PROTO STDCALL :
    DWORD
UnlockFile PROTO STDCALL :
DWORD,:
DWORD,:
DWORD,:
DWORD,:
    DWORD
UnlockFileEx PROTO STDCALL :
DWORD,:
DWORD,:
DWORD,:
DWORD,:
    DWORD
UnmapViewOfFile PROTO STDCALL :
    DWORD
UnregisterWait PROTO STDCALL :
    DWORD
UnregisterWaitEx PROTO STDCALL :
DWORD,:
    DWORD

UpdateResourceA PROTO STDCALL :
DWORD,:
DWORD,:
DWORD,:
DWORD,:
...
VerLanguageNameA PROTO STDCALL :
DWORD,:
DWORD,:
    DWORD
    IFNDEF __UNICODE__
...
VerLanguageNameW PROTO STDCALL :
DWORD,:
DWORD,:
    DWORD
    IFDEF __UNICODE__
...
VerSetConditionMask PROTO STDCALL :
DWORD,:
DWORD,:
DWORD,:
    DWORD

VerifyVersionInfoA PROTO STDCALL :
DWORD,:
DWORD,:
DWORD,:
    DWORD
...
VerifyVersionInfoW PROTO STDCALL :
DWORD,:
DWORD,:
DWORD,:
    DWORD
...
VirtualAlloc PROTO STDCALL :
DWORD,:
DWORD,:
DWORD,:
    DWORD
VirtualAllocEx PROTO STDCALL :
DWORD,:
DWORD,:
DWORD,:
DWORD,:
    DWORD
VirtualFree PROTO STDCALL :
DWORD,:
DWORD,:
    DWORD
VirtualFreeEx PROTO STDCALL :
DWORD,:
DWORD,:
DWORD,:
    DWORD
VirtualLock PROTO STDCALL :
DWORD,:
    DWORD
VirtualProtect PROTO STDCALL :
DWORD,:
DWORD,:
DWORD,:
    DWORD
VirtualProtectEx PROTO STDCALL :
DWORD,:
DWORD,:
DWORD,:
DWORD,:
    DWORD
VirtualQuery PROTO STDCALL :
DWORD,:
DWORD,:
    DWORD
VirtualQueryEx PROTO STDCALL :
DWORD,:
DWORD,:
DWORD,:
    DWORD
VirtualUnlock PROTO STDCALL :
DWORD,:
    DWORD
    WTSGetActiveConsoleSessionId PROTO STDCALL
WaitCommEvent PROTO STDCALL :
DWORD,:
DWORD,:
    DWORD
WaitForDebugEvent PROTO STDCALL :
DWORD,:
    DWORD
...
DWORD,:
    DWORD
WaitForMultipleObjectsEx PROTO STDCALL :
DWORD,:
DWORD,:
DWORD,:
DWORD,:
...
DWORD,:
    DWORD
WaitForSingleObjectEx PROTO STDCALL :
DWORD,:
DWORD,:
    DWORD

WaitNamedPipeA PROTO STDCALL :
DWORD,:
    DWORD
    IFNDEF __UNICODE__
...
WideCharToMultiByte PROTO STDCALL :
DWORD,:
DWORD,:
DWORD,:
DWORD,:
...
WriteConsoleInputA PROTO STDCALL :
DWORD,:
DWORD,:
DWORD,:
    DWORD
...
WriteConsoleInputW PROTO STDCALL :
DWORD,:
DWORD,:
DWORD,:
    DWORD
...
WriteConsoleOutputA PROTO STDCALL :
DWORD,:
DWORD,:
DWORD,:
DWORD,:
...
WriteConsoleOutputAttribute PROTO STDCALL :
DWORD,:
DWORD,:
DWORD,:
DWORD,:
...
WriteConsoleOutputCharacterA PROTO STDCALL :
DWORD,:
DWORD,:
DWORD,:
DWORD,:
...
WriteConsoleOutputCharacterW PROTO STDCALL :
DWORD,:
DWORD,:
DWORD,:
DWORD,:
...
WriteConsoleOutputW PROTO STDCALL :
DWORD,:
DWORD,:
DWORD,:
DWORD,:
...
DWORD,:
    DWORD
WriteFileEx PROTO STDCALL :
DWORD,:
DWORD,:
DWORD,:
DWORD,:
    DWORD
WriteFileGather PROTO STDCALL :
DWORD,:
DWORD,:
DWORD,:
DWORD,:
...
WritePrivateProfileSectionA PROTO STDCALL :
DWORD,:
DWORD,:
    DWORD
    IFNDEF __UNICODE__
...
WritePrivateProfileSectionW PROTO STDCALL :
DWORD,:
DWORD,:
    DWORD
    IFDEF __UNICODE__
...
WritePrivateProfileStringA PROTO STDCALL :
DWORD,:
DWORD,:
DWORD,:
    DWORD
...
WritePrivateProfileStringW PROTO STDCALL :
DWORD,:
DWORD,:
DWORD,:
    DWORD
...
WritePrivateProfileStructA PROTO STDCALL :
DWORD,:
DWORD,:
DWORD,:
DWORD,:
...
WritePrivateProfileStructW PROTO STDCALL :
DWORD,:
DWORD,:
DWORD,:
DWORD,:
...
WriteProcessMemory PROTO STDCALL :
DWORD,:
DWORD,:
DWORD,:
DWORD,:
...
WriteProfileSectionA PROTO STDCALL :
DWORD,:
    DWORD
    IFNDEF __UNICODE__
...
WriteProfileSectionW PROTO STDCALL :
DWORD,:
    DWORD
    IFDEF __UNICODE__
...
WriteProfileStringA PROTO STDCALL :
DWORD,:
DWORD,:
    DWORD
    IFNDEF __UNICODE__
...
WriteProfileStringW PROTO STDCALL :
DWORD,:
DWORD,:
    DWORD
    IFDEF __UNICODE__
...
WriteTapemark PROTO STDCALL :
DWORD,:
DWORD,:
DWORD,:
    DWORD
ZombifyActCtx PROTO STDCALL :
    DWORD
_hread PROTO STDCALL :
DWORD,:
DWORD,:
    DWORD
_hwrite PROTO STDCALL :
DWORD,:
DWORD,:
    DWORD
_lclose PROTO STDCALL :
    DWORD
_lcreat PROTO STDCALL :
DWORD,:
    DWORD
_llseek PROTO STDCALL :
DWORD,:
DWORD,:
    DWORD
_lopen PROTO STDCALL :
DWORD,:
    DWORD
_lread PROTO STDCALL :
DWORD,:
DWORD,:
    DWORD
_lwrite PROTO STDCALL :
DWORD,:
DWORD,:
    DWORD

lstrcatA PROTO STDCALL :
DWORD,:
    DWORD
    IFNDEF __UNICODE__
...
lstrlenA PROTO STDCALL :
    DWORD
    IFNDEF __UNICODE__
    lstrlen equ <lstrlenA>
    ENDIF

lstrlenW PROTO STDCALL :
    DWORD
    IFDEF __UNICODE__
