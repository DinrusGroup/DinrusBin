...
version(Win32_Winsock1) {
	pragma(msg, "Cannot use os.win32.winsock2 with Win32_Winsock1 defined.");
	static assert(false);
}

import os.win32.winbase;
import os.win32.windef;
import os.win32.basetyps;
...
private import os.win32.winerror;
private import os.win32.winbase;
