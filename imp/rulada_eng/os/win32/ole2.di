...
\***********************************************************************/
module os.win32.ole2;
pragma(lib, "ole32.lib");

public import os.win32.basetyps, os.win32.objbase, os.win32.oleauto, os.win32.olectlid,
  os.win32.oleidl, os.win32.unknwn, os.win32.winerror, os.win32.uuid;
private import os.win32.objfwd, os.win32.objidl, os.win32.windef, os.win32.wtypes;
