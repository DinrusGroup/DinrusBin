...
\***********************************************************************/
module os.win32.olectl;

// In conversion from MinGW, the following was deleted:
//#define FONTSIZE(n) {n##0000, 0}

import os.win32.ocidl, os.win32.olectlid;
private import os.win32.basetyps, os.win32.oaidl, os.win32.oleauto, os.win32.unknwn,
  os.win32.windef, os.win32.wingdi, os.win32.winuser, os.win32.wtypes;
private import os.win32.ntdef;     // for NTSTATUS
private import os.win32.objfwd;    // for LPSTREAM
private import os.win32.winerror;  // for SCODE
