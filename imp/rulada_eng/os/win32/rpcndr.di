...
import os.win32.rpcnsip;
private import os.win32.rpc, os.win32.rpcdce, os.win32.unknwn, os.win32.windef;
private import os.win32.objidl; // for IRpcChannelBuffer, IRpcStubBuffer
