...
\***********************************************************************/
module os.win32.commdlg;
pragma(lib, "comdlg32.lib");

private import os.win32.w32api;
import os.win32.windef, os.win32.winuser;
import os.win32.wingdi; // for LPLOGFONTA
...
static if (_WIN32_WINNT_ONLY && _WIN32_WINNT >= 0x500) {
	import os.win32.unknwn; // for LPUNKNOWN
	import os.win32.prsht;  // for HPROPSHEETPAGE
