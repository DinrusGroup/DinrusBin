...
\***********************************************************************/
module os.win32.aclui;
pragma(lib, "aclui.lib");

private import os.win32.w32api;

/*static assert (_WIN32_WINNT_ONLY && _WIN32_WINNT >= 0x500,
	"os.win32.aclui is available only if version WindowsXP, Windows2003 "
	"or WindowsVista is set, or both Windows2000 and WindowsNTonly are set");*/

import os.win32.accctrl, os.win32.commctrl, os.win32.objbase;
private import os.win32.basetyps, os.win32.prsht, os.win32.unknwn, os.win32.windef,
  os.win32.winuser;
