...
enum StringComparison {
  StringComparison_CurrentCulture = 0x00000000,
  StringComparison_CurrentCultureIgnoreCase = 0x00000001,
  StringComparison_InvariantCulture = 0x00000002,
  StringComparison_InvariantCultureIgnoreCase = 0x00000003,
  StringComparison_Ordinal = 0x00000004,
  StringComparison_OrdinalIgnoreCase = 0x00000005,
}

enum DateTimeKind {
  DateTimeKind_Unspecified = 0x00000000,
  DateTimeKind_Utc = 0x00000001,
  DateTimeKind_Local = 0x00000002,
}

enum AppDomainManagerInitializationOptions {
  AppDomainManagerInitializationOptions_None = 0x00000000,
  AppDomainManagerInitializationOptions_RegisterWithHost = 0x00000001,
}

enum LoaderOptimization {
  LoaderOptimization_NotSpecified = 0x00000000,
  LoaderOptimization_SingleDomain = 0x00000001,
  LoaderOptimization_MultiDomain = 0x00000002,
  LoaderOptimization_MultiDomainHost = 0x00000003,
  LoaderOptimization_DomainMask = 0x00000003,
  LoaderOptimization_DisallowBindings = 0x00000004,
}

enum AttributeTargets {
  AttributeTargets_Assembly = 0x00000001,
  AttributeTargets_Module = 0x00000002,
  AttributeTargets_Class = 0x00000004,
  AttributeTargets_Struct = 0x00000008,
  AttributeTargets_Enum = 0x00000010,
  AttributeTargets_Constructor = 0x00000020,
  AttributeTargets_Method = 0x00000040,
  AttributeTargets_Property = 0x00000080,
  AttributeTargets_Field = 0x00000100,
  AttributeTargets_Event = 0x00000200,
  AttributeTargets_Interface = 0x00000400,
  AttributeTargets_Parameter = 0x00000800,
  AttributeTargets_Delegate = 0x00001000,
  AttributeTargets_ReturnValue = 0x00002000,
  AttributeTargets_GenericParameter = 0x00004000,
  AttributeTargets_All = 0x00007FFF,
}

enum DayOfWeek {
  DayOfWeek_Sunday = 0x00000000,
  DayOfWeek_Monday = 0x00000001,
  DayOfWeek_Tuesday = 0x00000002,
  DayOfWeek_Wednesday = 0x00000003,
  DayOfWeek_Thursday = 0x00000004,
  DayOfWeek_Friday = 0x00000005,
  DayOfWeek_Saturday = 0x00000006,
}

enum EnvironmentVariableTarget {
  EnvironmentVariableTarget_Process = 0x00000000,
  EnvironmentVariableTarget_User = 0x00000001,
  EnvironmentVariableTarget_Machine = 0x00000002,
}

enum SpecialFolder {
  SpecialFolder_ApplicationData = 0x0000001A,
  SpecialFolder_CommonApplicationData = 0x00000023,
  SpecialFolder_LocalApplicationData = 0x0000001C,
  SpecialFolder_Cookies = 0x00000021,
  SpecialFolder_Desktop = 0x00000000,
  SpecialFolder_Favorites = 0x00000006,
  SpecialFolder_History = 0x00000022,
  SpecialFolder_InternetCache = 0x00000020,
  SpecialFolder_Programs = 0x00000002,
  SpecialFolder_MyComputer = 0x00000011,
  SpecialFolder_MyMusic = 0x0000000D,
  SpecialFolder_MyPictures = 0x00000027,
  SpecialFolder_Recent = 0x00000008,
  SpecialFolder_SendTo = 0x00000009,
  SpecialFolder_StartMenu = 0x0000000B,
  SpecialFolder_Startup = 0x00000007,
  SpecialFolder_System = 0x00000025,
  SpecialFolder_Templates = 0x00000015,
  SpecialFolder_DesktopDirectory = 0x00000010,
  SpecialFolder_Personal = 0x00000005,
  SpecialFolder_MyDocuments = 0x00000005,
  SpecialFolder_ProgramFiles = 0x00000026,
  SpecialFolder_CommonProgramFiles = 0x0000002B,
  SpecialFolder_AdminTools = 0x00000030,
  SpecialFolder_CDBurning = 0x0000003B,
  SpecialFolder_CommonAdminTools = 0x0000002F,
  SpecialFolder_CommonDocuments = 0x0000002E,
  SpecialFolder_CommonMusic = 0x00000035,
  SpecialFolder_CommonOemLinks = 0x0000003A,
  SpecialFolder_CommonPictures = 0x00000036,
  SpecialFolder_CommonStartMenu = 0x00000016,
  SpecialFolder_CommonPrograms = 0x00000017,
  SpecialFolder_CommonStartup = 0x00000018,
  SpecialFolder_CommonDesktopDirectory = 0x00000019,
  SpecialFolder_CommonTemplates = 0x0000002D,
  SpecialFolder_CommonVideos = 0x00000037,
  SpecialFolder_Fonts = 0x00000014,
  SpecialFolder_MyVideos = 0x0000000E,
  SpecialFolder_NetworkShortcuts = 0x00000013,
  SpecialFolder_PrinterShortcuts = 0x0000001B,
  SpecialFolder_UserProfile = 0x00000028,
  SpecialFolder_CommonProgramFilesX86 = 0x0000002C,
  SpecialFolder_ProgramFilesX86 = 0x0000002A,
  SpecialFolder_Resources = 0x00000038,
  SpecialFolder_LocalizedResources = 0x00000039,
  SpecialFolder_SystemX86 = 0x00000029,
  SpecialFolder_Windows = 0x00000024,
}

enum MidpointRounding {
  MidpointRounding_ToEven = 0x00000000,
  MidpointRounding_AwayFromZero = 0x00000001,
}

enum PlatformID {
  PlatformID_Win32S = 0x00000000,
  PlatformID_Win32Windows = 0x00000001,
  PlatformID_Win32NT = 0x00000002,
  PlatformID_WinCE = 0x00000003,
  PlatformID_Unix = 0x00000004,
  PlatformID_Xbox = 0x00000005,
  PlatformID_MacOSX = 0x00000006,
}

enum TypeCode {
  TypeCode_Empty = 0x00000000,
  TypeCode_Object = 0x00000001,
  TypeCode_DBNull = 0x00000002,
  TypeCode_Boolean = 0x00000003,
  TypeCode_Char = 0x00000004,
  TypeCode_SByte = 0x00000005,
  TypeCode_Byte = 0x00000006,
  TypeCode_Int16 = 0x00000007,
  TypeCode_UInt16 = 0x00000008,
  TypeCode_Int32 = 0x00000009,
  TypeCode_UInt32 = 0x0000000A,
  TypeCode_Int64 = 0x0000000B,
  TypeCode_UInt64 = 0x0000000C,
  TypeCode_Single = 0x0000000D,
  TypeCode_Double = 0x0000000E,
  TypeCode_Decimal = 0x0000000F,
  TypeCode_DateTime = 0x00000010,
  TypeCode_String = 0x00000012,
}

enum ThreadPriority {
  ThreadPriority_Lowest = 0x00000000,
  ThreadPriority_BelowNormal = 0x00000001,
  ThreadPriority_Normal = 0x00000002,
  ThreadPriority_AboveNormal = 0x00000003,
  ThreadPriority_Highest = 0x00000004,
}
...
enum ApartmentState {
  ApartmentState_STA = 0x00000000,
  ApartmentState_MTA = 0x00000001,
  ApartmentState_Unknown = 0x00000002,
}

enum DebuggingModes {
  DebuggingModes_None = 0x00000000,
  DebuggingModes_Default = 0x00000001,
  DebuggingModes_DisableOptimizations = 0x00000100,
  DebuggingModes_IgnoreSymbolStoreSequencePoints = 0x00000002,
  DebuggingModes_EnableEditAndContinue = 0x00000004,
}

enum DebuggerBrowsableState {
  DebuggerBrowsableState_Never = 0x00000000,
  DebuggerBrowsableState_Collapsed = 0x00000002,
  DebuggerBrowsableState_RootHidden = 0x00000003,
}

enum SymAddressKind {
  SymAddressKind_ILOffset = 0x00000001,
  SymAddressKind_NativeRVA = 0x00000002,
  SymAddressKind_NativeRegister = 0x00000003,
  SymAddressKind_NativeRegisterRelative = 0x00000004,
  SymAddressKind_NativeOffset = 0x00000005,
  SymAddressKind_NativeRegisterRegister = 0x00000006,
  SymAddressKind_NativeRegisterStack = 0x00000007,
  SymAddressKind_NativeStackRegister = 0x00000008,
  SymAddressKind_BitField = 0x00000009,
  SymAddressKind_NativeSectionOffset = 0x0000000A,
}

enum AssemblyNameFlags {
  AssemblyNameFlags_None = 0x00000000,
  AssemblyNameFlags_PublicKey = 0x00000001,
  AssemblyNameFlags_EnableJITcompileOptimizer = 0x00004000,
  AssemblyNameFlags_EnableJITcompileTracking = 0x00008000,
  AssemblyNameFlags_Retargetable = 0x00000100,
}

enum ProcessorArchitecture {
  ProcessorArchitecture_None = 0x00000000,
  ProcessorArchitecture_MSIL = 0x00000001,
  ProcessorArchitecture_X86 = 0x00000002,
  ProcessorArchitecture_IA64 = 0x00000003,
  ProcessorArchitecture_Amd64 = 0x00000004,
}

enum BindingFlags {
  BindingFlags_Default = 0x00000000,
  BindingFlags_IgnoreCase = 0x00000001,
  ...
  BindingFlags_FlattenHierarchy = 0x00000040,
  BindingFlags_InvokeMethod = 0x00000100,
  BindingFlags_CreateInstance = 0x00000200,
  BindingFlags_GetField = 0x00000400,
  BindingFlags_SetField = 0x00000800,
  BindingFlags_GetProperty = 0x00001000,
  BindingFlags_SetProperty = 0x00002000,
  BindingFlags_PutDispProperty = 0x00004000,
  BindingFlags_PutRefDispProperty = 0x00008000,
...
enum CallingConventions {
  CallingConventions_Standard = 0x00000001,
  CallingConventions_VarArgs = 0x00000002,
  CallingConventions_Any = 0x00000003,
  CallingConventions_HasThis = 0x00000020,
  CallingConventions_ExplicitThis = 0x00000040,
}

enum EventAttributes {
  EventAttributes_None = 0x00000000,
  EventAttributes_SpecialName = 0x00000200,
  EventAttributes_ReservedMask = 0x00000400,
  EventAttributes_RTSpecialName = 0x00000400,
}

enum FieldAttributes {
  FieldAttributes_FieldAccessMask = 0x00000007,
  FieldAttributes_PrivateScope = 0x00000000,
  FieldAttributes_Private = 0x00000001,
  FieldAttributes_FamANDAssem = 0x00000002,
  FieldAttributes_Assembly = 0x00000003,
  FieldAttributes_Family = 0x00000004,
  FieldAttributes_FamORAssem = 0x00000005,
  FieldAttributes_Public = 0x00000006,
  FieldAttributes_Static = 0x00000010,
  FieldAttributes_InitOnly = 0x00000020,
  FieldAttributes_Literal = 0x00000040,
  FieldAttributes_NotSerialized = 0x00000080,
  FieldAttributes_SpecialName = 0x00000200,
  FieldAttributes_PinvokeImpl = 0x00002000,
  FieldAttributes_ReservedMask = 0x00009500,
  FieldAttributes_RTSpecialName = 0x00000400,
  FieldAttributes_HasFieldMarshal = 0x00001000,
  FieldAttributes_HasDefault = 0x00008000,
  FieldAttributes_HasFieldRVA = 0x00000100,
}

enum ResourceLocation {
  ResourceLocation_Embedded = 0x00000001,
  ResourceLocation_ContainedInAnotherAssembly = 0x00000002,
  ResourceLocation_ContainedInManifestFile = 0x00000004,
}

enum MemberTypes {
  MemberTypes_Constructor = 0x00000001,
  MemberTypes_Event = 0x00000002,
  MemberTypes_Field = 0x00000004,
  MemberTypes_Method = 0x00000008,
  MemberTypes_Property = 0x00000010,
  MemberTypes_TypeInfo = 0x00000020,
  MemberTypes_Custom = 0x00000040,
  MemberTypes_NestedType = 0x00000080,
  MemberTypes_All = 0x000000BF,
}

enum MethodAttributes {
  MethodAttributes_MemberAccessMask = 0x00000007,
  MethodAttributes_PrivateScope = 0x00000000,
  MethodAttributes_Private = 0x00000001,
  MethodAttributes_FamANDAssem = 0x00000002,
  MethodAttributes_Assembly = 0x00000003,
  MethodAttributes_Family = 0x00000004,
  MethodAttributes_FamORAssem = 0x00000005,
  MethodAttributes_Public = 0x00000006,
  MethodAttributes_Static = 0x00000010,
  MethodAttributes_Final = 0x00000020,
  MethodAttributes_Virtual = 0x00000040,
  MethodAttributes_HideBySig = 0x00000080,
  MethodAttributes_CheckAccessOnOverride = 0x00000200,
  MethodAttributes_VtableLayoutMask = 0x00000100,
  MethodAttributes_ReuseSlot = 0x00000000,
  MethodAttributes_NewSlot = 0x00000100,
  MethodAttributes_Abstract = 0x00000400,
  MethodAttributes_SpecialName = 0x00000800,
  MethodAttributes_PinvokeImpl = 0x00002000,
  MethodAttributes_UnmanagedExport = 0x00000008,
  MethodAttributes_RTSpecialName = 0x00001000,
  MethodAttributes_ReservedMask = 0x0000D000,
  MethodAttributes_HasSecurity = 0x00004000,
  MethodAttributes_RequireSecObject = 0x00008000,
}

enum MethodImplAttributes {
  MethodImplAttributes_CodeTypeMask = 0x00000003,
  MethodImplAttributes_IL = 0x00000000,
  MethodImplAttributes_Native = 0x00000001,
  MethodImplAttributes_OPTIL = 0x00000002,
  MethodImplAttributes_Runtime = 0x00000003,
  MethodImplAttributes_ManagedMask = 0x00000004,
  MethodImplAttributes_Unmanaged = 0x00000004,
  MethodImplAttributes_Managed = 0x00000000,
  MethodImplAttributes_ForwardRef = 0x00000010,
  MethodImplAttributes_PreserveSig = 0x00000080,
  MethodImplAttributes_InternalCall = 0x00001000,
  MethodImplAttributes_Synchronized = 0x00000020,
  MethodImplAttributes_NoInlining = 0x00000008,
  MethodImplAttributes_NoOptimization = 0x00000040,
  MethodImplAttributes_MaxMethodImplVal = 0x0000FFFF,
}

enum PortableExecutableKinds {
  PortableExecutableKinds_NotAPortableExecutableImage = 0x00000000,
  PortableExecutableKinds_ILOnly = 0x00000001,
  PortableExecutableKinds_Required32Bit = 0x00000002,
  PortableExecutableKinds_PE32Plus = 0x00000004,
  PortableExecutableKinds_Unmanaged32Bit = 0x00000008,
}

enum ImageFileMachine {
  ImageFileMachine_I386 = 0x0000014C,
  ImageFileMachine_IA64 = 0x00000200,
  ImageFileMachine_AMD64 = 0x00008664,
}

enum ExceptionHandlingClauseOptions {
  ExceptionHandlingClauseOptions_Clause = 0x00000000,
  ExceptionHandlingClauseOptions_Filter = 0x00000001,
  ExceptionHandlingClauseOptions_Finally = 0x00000002,
  ExceptionHandlingClauseOptions_Fault = 0x00000004,
}

enum ParameterAttributes {
  ParameterAttributes_None = 0x00000000,
  ParameterAttributes_In = 0x00000001,
  ParameterAttributes_Out = 0x00000002,
  ParameterAttributes_Lcid = 0x00000004,
  ParameterAttributes_Retval = 0x00000008,
  ParameterAttributes_Optional = 0x00000010,
  ParameterAttributes_ReservedMask = 0x0000F000,
  ParameterAttributes_HasDefault = 0x00001000,
  ParameterAttributes_HasFieldMarshal = 0x00002000,
  ParameterAttributes_Reserved3 = 0x00004000,
  ParameterAttributes_Reserved4 = 0x00008000,
}

enum PropertyAttributes {
  PropertyAttributes_None = 0x00000000,
  PropertyAttributes_SpecialName = 0x00000200,
  PropertyAttributes_ReservedMask = 0x0000F400,
  PropertyAttributes_RTSpecialName = 0x00000400,
  PropertyAttributes_HasDefault = 0x00001000,
  PropertyAttributes_Reserved2 = 0x00002000,
  PropertyAttributes_Reserved3 = 0x00004000,
  PropertyAttributes_Reserved4 = 0x00008000,
}

enum ResourceAttributes {
  ResourceAttributes_Public = 0x00000001,
  ResourceAttributes_Private = 0x00000002,
}
...
enum TypeAttributes {
  ...
  TypeAttributes_CustomFormatMask = 0x00C00000,
  TypeAttributes_BeforeFieldInit = 0x00100000,
  TypeAttributes_ReservedMask = 0x00040800,
  TypeAttributes_RTSpecialName = 0x00000800,
  TypeAttributes_HasSecurity = 0x00040000,
}

enum StreamingContextStates {
  StreamingContextStates_CrossProcess = 0x00000001,
  StreamingContextStates_CrossMachine = 0x00000002,
  StreamingContextStates_File = 0x00000004,
  StreamingContextStates_Persistence = 0x00000008,
  StreamingContextStates_Remoting = 0x00000010,
  StreamingContextStates_Other = 0x00000020,
  StreamingContextStates_Clone = 0x00000040,
  StreamingContextStates_CrossAppDomain = 0x00000080,
  StreamingContextStates_All = 0x000000FF,
}

enum CalendarAlgorithmType {
  CalendarAlgorithmType_Unknown = 0x00000000,
  CalendarAlgorithmType_SolarCalendar = 0x00000001,
  CalendarAlgorithmType_LunarCalendar = 0x00000002,
  CalendarAlgorithmType_LunisolarCalendar = 0x00000003,
}

enum CalendarWeekRule {
  CalendarWeekRule_FirstDay = 0x00000000,
  CalendarWeekRule_FirstFullWeek = 0x00000001,
  CalendarWeekRule_FirstFourDayWeek = 0x00000002,
}

enum CompareOptions {
  CompareOptions_None = 0x00000000,
  CompareOptions_IgnoreCase = 0x00000001,
  CompareOptions_IgnoreNonSpace = 0x00000002,
  CompareOptions_IgnoreSymbols = 0x00000004,
  CompareOptions_IgnoreKanaType = 0x00000008,
  CompareOptions_IgnoreWidth = 0x00000010,
...
enum CultureTypes {
  CultureTypes_NeutralCultures = 0x00000001,
  CultureTypes_SpecificCultures = 0x00000002,
  CultureTypes_InstalledWin32Cultures = 0x00000004,
  CultureTypes_AllCultures = 0x00000007,
  CultureTypes_UserCustomCulture = 0x00000008,
  CultureTypes_ReplacementCultures = 0x00000010,
  CultureTypes_WindowsOnlyCultures = 0x00000020,
  CultureTypes_FrameworkCultures = 0x00000040,
}

enum DateTimeStyles {
  DateTimeStyles_None = 0x00000000,
  DateTimeStyles_AllowLeadingWhite = 0x00000001,
  DateTimeStyles_AllowTrailingWhite = 0x00000002,
  DateTimeStyles_AllowInnerWhite = 0x00000004,
  DateTimeStyles_AllowWhiteSpaces = 0x00000007,
  DateTimeStyles_NoCurrentDateDefault = 0x00000008,
  DateTimeStyles_AdjustToUniversal = 0x00000010,
  DateTimeStyles_AssumeLocal = 0x00000020,
  DateTimeStyles_AssumeUniversal = 0x00000040,
  DateTimeStyles_RoundTripKind = 0x00000080,
}

enum DigitShapes {
  DigitShapes_Context = 0x00000000,
  DigitShapes_None = 0x00000001,
  DigitShapes_NativeNational = 0x00000002,
}

enum GregorianCalendarTypes {
  GregorianCalendarTypes_Localized = 0x00000001,
  GregorianCalendarTypes_USEnglish = 0x00000002,
  GregorianCalendarTypes_MiddleEastFrench = 0x00000009,
  GregorianCalendarTypes_Arabic = 0x0000000A,
  GregorianCalendarTypes_TransliteratedEnglish = 0x0000000B,
  GregorianCalendarTypes_TransliteratedFrench = 0x0000000C,
}

enum NumberStyles {
  NumberStyles_None = 0x00000000,
  NumberStyles_AllowLeadingWhite = 0x00000001,
  NumberStyles_AllowTrailingWhite = 0x00000002,
  NumberStyles_AllowLeadingSign = 0x00000004,
  NumberStyles_AllowTrailingSign = 0x00000008,
  NumberStyles_AllowParentheses = 0x00000010,
  NumberStyles_AllowDecimalPoint = 0x00000020,
  NumberStyles_AllowThousands = 0x00000040,
  NumberStyles_AllowExponent = 0x00000080,
  NumberStyles_AllowCurrencySymbol = 0x00000100,
  NumberStyles_AllowHexSpecifier = 0x00000200,
  NumberStyles_Integer = 0x00000007,
  NumberStyles_HexNumber = 0x00000203,
  NumberStyles_Number = 0x0000006F,
  NumberStyles_Float = 0x000000A7,
  NumberStyles_Currency = 0x0000017F,
  NumberStyles_Any = 0x000001FF,
}

enum UnicodeCategory {
  UnicodeCategory_UppercaseLetter = 0x00000000,
  UnicodeCategory_LowercaseLetter = 0x00000001,
  UnicodeCategory_TitlecaseLetter = 0x00000002,
  UnicodeCategory_ModifierLetter = 0x00000003,
  UnicodeCategory_OtherLetter = 0x00000004,
  UnicodeCategory_NonSpacingMark = 0x00000005,
  UnicodeCategory_SpacingCombiningMark = 0x00000006,
  UnicodeCategory_EnclosingMark = 0x00000007,
  UnicodeCategory_DecimalDigitNumber = 0x00000008,
  UnicodeCategory_LetterNumber = 0x00000009,
  UnicodeCategory_OtherNumber = 0x0000000A,
  UnicodeCategory_SpaceSeparator = 0x0000000B,
  UnicodeCategory_LineSeparator = 0x0000000C,
  UnicodeCategory_ParagraphSeparator = 0x0000000D,
  UnicodeCategory_Control = 0x0000000E,
  UnicodeCategory_Format = 0x0000000F,
  UnicodeCategory_Surrogate = 0x00000010,
  UnicodeCategory_PrivateUse = 0x00000011,
  UnicodeCategory_ConnectorPunctuation = 0x00000012,
  UnicodeCategory_DashPunctuation = 0x00000013,
  UnicodeCategory_OpenPunctuation = 0x00000014,
  UnicodeCategory_ClosePunctuation = 0x00000015,
  UnicodeCategory_InitialQuotePunctuation = 0x00000016,
  UnicodeCategory_FinalQuotePunctuation = 0x00000017,
  UnicodeCategory_OtherPunctuation = 0x00000018,
  UnicodeCategory_MathSymbol = 0x00000019,
  UnicodeCategory_CurrencySymbol = 0x0000001A,
  UnicodeCategory_ModifierSymbol = 0x0000001B,
  UnicodeCategory_OtherSymbol = 0x0000001C,
  UnicodeCategory_OtherNotAssigned = 0x0000001D,
}

enum NormalizationForm {
  NormalizationForm_FormC = 0x00000001,
  NormalizationForm_FormD = 0x00000002,
  NormalizationForm_FormKC = 0x00000005,
  NormalizationForm_FormKD = 0x00000006,
}

enum UltimateResourceFallbackLocation {
  UltimateResourceFallbackLocation_MainAssembly = 0x00000000,
  UltimateResourceFallbackLocation_Satellite = 0x00000001,
}
...
enum RegistryValueKind {
  RegistryValueKind_String = 0x00000001,
  RegistryValueKind_ExpandString = 0x00000002,
  RegistryValueKind_Binary = 0x00000003,
  RegistryValueKind_DWord = 0x00000004,
  RegistryValueKind_MultiString = 0x00000007,
  RegistryValueKind_QWord = 0x0000000B,
  RegistryValueKind_Unknown = 0x00000000,
}

enum ApplicationVersionMatch {
  ApplicationVersionMatch_MatchExactVersion = 0x00000000,
  ApplicationVersionMatch_MatchAllVersions = 0x00000001,
}

enum TrustManagerUIContext {
  TrustManagerUIContext_Install = 0x00000000,
  TrustManagerUIContext_Upgrade = 0x00000001,
  TrustManagerUIContext_Run = 0x00000002,
}

enum PolicyStatementAttribute {
  PolicyStatementAttribute_Nothing = 0x00000000,
  PolicyStatementAttribute_Exclusive = 0x00000001,
  PolicyStatementAttribute_LevelFinal = 0x00000002,
  PolicyStatementAttribute_All = 0x00000003,
}

enum PrincipalPolicy {
  PrincipalPolicy_UnauthenticatedPrincipal = 0x00000000,
  PrincipalPolicy_NoPrincipal = 0x00000001,
  PrincipalPolicy_WindowsPrincipal = 0x00000002,
}

enum WindowsAccountType {
  WindowsAccountType_Normal = 0x00000000,
  WindowsAccountType_Guest = 0x00000001,
  WindowsAccountType_System = 0x00000002,
  WindowsAccountType_Anonymous = 0x00000003,
}

enum TokenImpersonationLevel {
  TokenImpersonationLevel_None = 0x00000000,
  TokenImpersonationLevel_Anonymous = 0x00000001,
  TokenImpersonationLevel_Identification = 0x00000002,
  TokenImpersonationLevel_Impersonation = 0x00000003,
  TokenImpersonationLevel_Delegation = 0x00000004,
}

enum TokenAccessLevels {
  TokenAccessLevels_AssignPrimary = 0x00000001,
  TokenAccessLevels_Duplicate = 0x00000002,
  TokenAccessLevels_Impersonate = 0x00000004,
  TokenAccessLevels_Query = 0x00000008,
  TokenAccessLevels_QuerySource = 0x00000010,
  TokenAccessLevels_AdjustPrivileges = 0x00000020,
  TokenAccessLevels_AdjustGroups = 0x00000040,
  TokenAccessLevels_AdjustDefault = 0x00000080,
  TokenAccessLevels_AdjustSessionId = 0x00000100,
  TokenAccessLevels_Read = 0x00020008,
  TokenAccessLevels_Write = 0x000200E0,
  TokenAccessLevels_AllAccess = 0x000F01FF,
  TokenAccessLevels_MaximumAllowed = 0x02000000,
}

enum WindowsBuiltInRole {
  WindowsBuiltInRole_Administrator = 0x00000220,
  WindowsBuiltInRole_User = 0x00000221,
  WindowsBuiltInRole_Guest = 0x00000222,
  WindowsBuiltInRole_PowerUser = 0x00000223,
  WindowsBuiltInRole_AccountOperator = 0x00000224,
  WindowsBuiltInRole_SystemOperator = 0x00000225,
  WindowsBuiltInRole_PrintOperator = 0x00000226,
  WindowsBuiltInRole_BackupOperator = 0x00000227,
  WindowsBuiltInRole_Replicator = 0x00000228,
}

enum ComInterfaceType {
  ComInterfaceType_InterfaceIsDual = 0x00000000,
  ComInterfaceType_InterfaceIsIUnknown = 0x00000001,
  ComInterfaceType_InterfaceIsIDispatch = 0x00000002,
}

enum ClassInterfaceType {
  ClassInterfaceType_None = 0x00000000,
  ClassInterfaceType_AutoDispatch = 0x00000001,
  ClassInterfaceType_AutoDual = 0x00000002,
}

enum IDispatchImplType {
  IDispatchImplType_SystemDefinedImpl = 0x00000000,
  IDispatchImplType_InternalImpl = 0x00000001,
  IDispatchImplType_CompatibleImpl = 0x00000002,
}

enum TypeLibTypeFlags {
  TypeLibTypeFlags_FAppObject = 0x00000001,
  TypeLibTypeFlags_FCanCreate = 0x00000002,
  TypeLibTypeFlags_FLicensed = 0x00000004,
  TypeLibTypeFlags_FPreDeclId = 0x00000008,
  TypeLibTypeFlags_FHidden = 0x00000010,
  TypeLibTypeFlags_FControl = 0x00000020,
  TypeLibTypeFlags_FDual = 0x00000040,
  TypeLibTypeFlags_FNonExtensible = 0x00000080,
  TypeLibTypeFlags_FOleAutomation = 0x00000100,
  TypeLibTypeFlags_FRestricted = 0x00000200,
  TypeLibTypeFlags_FAggregatable = 0x00000400,
  TypeLibTypeFlags_FReplaceable = 0x00000800,
  TypeLibTypeFlags_FDispatchable = 0x00001000,
  TypeLibTypeFlags_FReverseBind = 0x00002000,
}

enum TypeLibFuncFlags {
  TypeLibFuncFlags_FRestricted = 0x00000001,
  TypeLibFuncFlags_FSource = 0x00000002,
  TypeLibFuncFlags_FBindable = 0x00000004,
  TypeLibFuncFlags_FRequestEdit = 0x00000008,
  TypeLibFuncFlags_FDisplayBind = 0x00000010,
  TypeLibFuncFlags_FDefaultBind = 0x00000020,
  TypeLibFuncFlags_FHidden = 0x00000040,
  TypeLibFuncFlags_FUsesGetLastError = 0x00000080,
  TypeLibFuncFlags_FDefaultCollelem = 0x00000100,
  TypeLibFuncFlags_FUiDefault = 0x00000200,
  TypeLibFuncFlags_FNonBrowsable = 0x00000400,
  TypeLibFuncFlags_FReplaceable = 0x00000800,
  TypeLibFuncFlags_FImmediateBind = 0x00001000,
}

enum TypeLibVarFlags {
  TypeLibVarFlags_FReadOnly = 0x00000001,
  TypeLibVarFlags_FSource = 0x00000002,
  TypeLibVarFlags_FBindable = 0x00000004,
  TypeLibVarFlags_FRequestEdit = 0x00000008,
  TypeLibVarFlags_FDisplayBind = 0x00000010,
  TypeLibVarFlags_FDefaultBind = 0x00000020,
  TypeLibVarFlags_FHidden = 0x00000040,
  TypeLibVarFlags_FRestricted = 0x00000080,
  TypeLibVarFlags_FDefaultCollelem = 0x00000100,
  TypeLibVarFlags_FUiDefault = 0x00000200,
  TypeLibVarFlags_FNonBrowsable = 0x00000400,
  TypeLibVarFlags_FReplaceable = 0x00000800,
  TypeLibVarFlags_FImmediateBind = 0x00001000,
}

enum VarEnum {
  VarEnum_VT_EMPTY = 0x00000000,
  VarEnum_VT_NULL = 0x00000001,
  VarEnum_VT_I2 = 0x00000002,
  VarEnum_VT_I4 = 0x00000003,
  VarEnum_VT_R4 = 0x00000004,
  VarEnum_VT_R8 = 0x00000005,
  VarEnum_VT_CY = 0x00000006,
  VarEnum_VT_DATE = 0x00000007,
  VarEnum_VT_BSTR = 0x00000008,
  VarEnum_VT_DISPATCH = 0x00000009,
  VarEnum_VT_ERROR = 0x0000000A,
  VarEnum_VT_BOOL = 0x0000000B,
  VarEnum_VT_VARIANT = 0x0000000C,
  VarEnum_VT_UNKNOWN = 0x0000000D,
  VarEnum_VT_DECIMAL = 0x0000000E,
  VarEnum_VT_I1 = 0x00000010,
  VarEnum_VT_UI1 = 0x00000011,
  VarEnum_VT_UI2 = 0x00000012,
  VarEnum_VT_UI4 = 0x00000013,
  VarEnum_VT_I8 = 0x00000014,
  VarEnum_VT_UI8 = 0x00000015,
  VarEnum_VT_INT = 0x00000016,
  VarEnum_VT_UINT = 0x00000017,
  VarEnum_VT_VOID = 0x00000018,
  VarEnum_VT_HRESULT = 0x00000019,
  VarEnum_VT_PTR = 0x0000001A,
  VarEnum_VT_SAFEARRAY = 0x0000001B,
  VarEnum_VT_CARRAY = 0x0000001C,
  VarEnum_VT_USERDEFINED = 0x0000001D,
  VarEnum_VT_LPSTR = 0x0000001E,
  VarEnum_VT_LPWSTR = 0x0000001F,
  VarEnum_VT_RECORD = 0x00000024,
  VarEnum_VT_FILETIME = 0x00000040,
  VarEnum_VT_BLOB = 0x00000041,
  VarEnum_VT_STREAM = 0x00000042,
  VarEnum_VT_STORAGE = 0x00000043,
  VarEnum_VT_STREAMED_OBJECT = 0x00000044,
  VarEnum_VT_STORED_OBJECT = 0x00000045,
  VarEnum_VT_BLOB_OBJECT = 0x00000046,
  VarEnum_VT_CF = 0x00000047,
  VarEnum_VT_CLSID = 0x00000048,
  VarEnum_VT_VECTOR = 0x00001000,
  VarEnum_VT_ARRAY = 0x00002000,
  VarEnum_VT_BYREF = 0x00004000,
}

enum UnmanagedType {
  UnmanagedType_Bool = 0x00000002,
  UnmanagedType_I1 = 0x00000003,
  UnmanagedType_U1 = 0x00000004,
  UnmanagedType_I2 = 0x00000005,
  UnmanagedType_U2 = 0x00000006,
  UnmanagedType_I4 = 0x00000007,
  UnmanagedType_U4 = 0x00000008,
  UnmanagedType_I8 = 0x00000009,
  UnmanagedType_U8 = 0x0000000A,
  UnmanagedType_R4 = 0x0000000B,
  UnmanagedType_R8 = 0x0000000C,
  UnmanagedType_Currency = 0x0000000F,
  UnmanagedType_BStr = 0x00000013,
  UnmanagedType_LPStr = 0x00000014,
  UnmanagedType_LPWStr = 0x00000015,
  UnmanagedType_LPTStr = 0x00000016,
  UnmanagedType_ByValTStr = 0x00000017,
  UnmanagedType_IUnknown = 0x00000019,
  UnmanagedType_IDispatch = 0x0000001A,
  UnmanagedType_Struct = 0x0000001B,
  UnmanagedType_Interface = 0x0000001C,
  UnmanagedType_SafeArray = 0x0000001D,
  UnmanagedType_ByValArray = 0x0000001E,
  UnmanagedType_SysInt = 0x0000001F,
  UnmanagedType_SysUInt = 0x00000020,
  UnmanagedType_VBByRefStr = 0x00000022,
  UnmanagedType_AnsiBStr = 0x00000023,
  UnmanagedType_TBStr = 0x00000024,
  UnmanagedType_VariantBool = 0x00000025,
  UnmanagedType_FunctionPtr = 0x00000026,
  UnmanagedType_AsAny = 0x00000028,
  UnmanagedType_LPArray = 0x0000002A,
  UnmanagedType_LPStruct = 0x0000002B,
  UnmanagedType_CustomMarshaler = 0x0000002C,
  UnmanagedType_Error = 0x0000002D,
}

enum CallingConvention {
  CallingConvention_Winapi = 0x00000001,
  CallingConvention_Cdecl = 0x00000002,
  CallingConvention_StdCall = 0x00000003,
  CallingConvention_ThisCall = 0x00000004,
  CallingConvention_FastCall = 0x00000005,
}

enum CharSet {
  CharSet_None = 0x00000001,
  CharSet_Ansi = 0x00000002,
  CharSet_Unicode = 0x00000003,
  CharSet_Auto = 0x00000004,
}

enum GCHandleType {
  GCHandleType_Weak = 0x00000000,
  GCHandleType_WeakTrackResurrection = 0x00000001,
  GCHandleType_Normal = 0x00000002,
  GCHandleType_Pinned = 0x00000003,
}

enum LayoutKind {
  LayoutKind_Sequential = 0x00000000,
  LayoutKind_Explicit = 0x00000002,
  LayoutKind_Auto = 0x00000003,
}

enum ComMemberType {
  ComMemberType_Method = 0x00000000,
  ComMemberType_PropGet = 0x00000001,
  ComMemberType_PropSet = 0x00000002,
}

enum AssemblyRegistrationFlags {
  AssemblyRegistrationFlags_None = 0x00000000,
  AssemblyRegistrationFlags_SetCodeBase = 0x00000001,
}

enum TypeLibImporterFlags {
  TypeLibImporterFlags_None = 0x00000000,
  TypeLibImporterFlags_PrimaryInteropAssembly = 0x00000001,
  TypeLibImporterFlags_UnsafeInterfaces = 0x00000002,
  TypeLibImporterFlags_SafeArrayAsSystemArray = 0x00000004,
  TypeLibImporterFlags_TransformDispRetVals = 0x00000008,
  TypeLibImporterFlags_PreventClassMembers = 0x00000010,
  TypeLibImporterFlags_SerializableValueClasses = 0x00000020,
  TypeLibImporterFlags_ImportAsX86 = 0x00000100,
  TypeLibImporterFlags_ImportAsX64 = 0x00000200,
  TypeLibImporterFlags_ImportAsItanium = 0x00000400,
  TypeLibImporterFlags_ImportAsAgnostic = 0x00000800,
  TypeLibImporterFlags_ReflectionOnlyLoading = 0x00001000,
  TypeLibImporterFlags_NoDefineVersionResource = 0x00002000,
}

enum TypeLibExporterFlags {
  TypeLibExporterFlags_None = 0x00000000,
  TypeLibExporterFlags_OnlyReferenceRegistered = 0x00000001,
  TypeLibExporterFlags_CallerResolvedReferences = 0x00000002,
  TypeLibExporterFlags_OldNames = 0x00000004,
  TypeLibExporterFlags_ExportAs32Bit = 0x00000010,
  TypeLibExporterFlags_ExportAs64Bit = 0x00000020,
}

enum ImporterEventKind {
  ImporterEventKind_NOTIF_TYPECONVERTED = 0x00000000,
  ImporterEventKind_NOTIF_CONVERTWARNING = 0x00000001,
  ImporterEventKind_ERROR_REFTOINVALIDTYPELIB = 0x00000002,
}

enum ExporterEventKind {
  ExporterEventKind_NOTIF_TYPECONVERTED = 0x00000000,
  ExporterEventKind_NOTIF_CONVERTWARNING = 0x00000001,
  ExporterEventKind_ERROR_REFTOINVALIDASSEMBLY = 0x00000002,
}

enum SearchOption {
  SearchOption_TopDirectoryOnly = 0x00000000,
  SearchOption_AllDirectories = 0x00000001,
}

enum DriveType {
  DriveType_Unknown = 0x00000000,
  DriveType_NoRootDirectory = 0x00000001,
  DriveType_Removable = 0x00000002,
  DriveType_Fixed = 0x00000003,
  DriveType_Network = 0x00000004,
  DriveType_CDRom = 0x00000005,
  DriveType_Ram = 0x00000006,
}

enum FileAccess {
  FileAccess_Read = 0x00000001,
  FileAccess_Write = 0x00000002,
  FileAccess_ReadWrite = 0x00000003,
}

enum FileMode {
  FileMode_CreateNew = 0x00000001,
  FileMode_Create = 0x00000002,
  FileMode_Open = 0x00000003,
  FileMode_OpenOrCreate = 0x00000004,
  FileMode_Truncate = 0x00000005,
  FileMode_Append = 0x00000006,
}

enum FileOptions {
  FileOptions_None = 0x00000000,
  FileOptions_WriteThrough = 0x80000000,
  FileOptions_Asynchronous = 0x40000000,
  FileOptions_RandomAccess = 0x10000000,
  FileOptions_DeleteOnClose = 0x04000000,
  FileOptions_SequentialScan = 0x08000000,
  FileOptions_Encrypted = 0x00004000,
}

enum FileShare {
  FileShare_None = 0x00000000,
  FileShare_Read = 0x00000001,
  FileShare_Write = 0x00000002,
  FileShare_ReadWrite = 0x00000003,
  FileShare_Delete = 0x00000004,
  FileShare_Inheritable = 0x00000010,
}

enum FileAttributes {
  FileAttributes_ReadOnly = 0x00000001,
  FileAttributes_Hidden = 0x00000002,
  FileAttributes_System = 0x00000004,
  FileAttributes_Directory = 0x00000010,
  FileAttributes_Archive = 0x00000020,
  FileAttributes_Device = 0x00000040,
  FileAttributes_Normal = 0x00000080,
  FileAttributes_Temporary = 0x00000100,
  FileAttributes_SparseFile = 0x00000200,
  FileAttributes_ReparsePoint = 0x00000400,
  FileAttributes_Compressed = 0x00000800,
  FileAttributes_Offline = 0x00001000,
  FileAttributes_NotContentIndexed = 0x00002000,
  FileAttributes_Encrypted = 0x00004000,
}

enum SeekOrigin {
  SeekOrigin_Begin = 0x00000000,
  SeekOrigin_Current = 0x00000001,
  SeekOrigin_End = 0x00000002,
}
...
enum MethodImplOptions {
  MethodImplOptions_Unmanaged = 0x00000004,
  MethodImplOptions_ForwardRef = 0x00000010,
  MethodImplOptions_PreserveSig = 0x00000080,
  MethodImplOptions_InternalCall = 0x00001000,
  MethodImplOptions_Synchronized = 0x00000020,
  MethodImplOptions_NoInlining = 0x00000008,
  MethodImplOptions_NoOptimization = 0x00000040,
}

enum MethodCodeType {
  MethodCodeType_IL = 0x00000000,
  MethodCodeType_Native = 0x00000001,
  MethodCodeType_OPTIL = 0x00000002,
  MethodCodeType_Runtime = 0x00000003,
}

enum EnvironmentPermissionAccess {
  EnvironmentPermissionAccess_NoAccess = 0x00000000,
  EnvironmentPermissionAccess_Read = 0x00000001,
  EnvironmentPermissionAccess_Write = 0x00000002,
  EnvironmentPermissionAccess_AllAccess = 0x00000003,
}

enum FileDialogPermissionAccess {
  FileDialogPermissionAccess_None = 0x00000000,
  FileDialogPermissionAccess_Open = 0x00000001,
  FileDialogPermissionAccess_Save = 0x00000002,
  FileDialogPermissionAccess_OpenSave = 0x00000003,
}

enum FileIOPermissionAccess {
  FileIOPermissionAccess_NoAccess = 0x00000000,
  FileIOPermissionAccess_Read = 0x00000001,
  FileIOPermissionAccess_Write = 0x00000002,
  FileIOPermissionAccess_Append = 0x00000004,
  FileIOPermissionAccess_PathDiscovery = 0x00000008,
  FileIOPermissionAccess_AllAccess = 0x0000000F,
}

enum HostProtectionResource {
  HostProtectionResource_None = 0x00000000,
  HostProtectionResource_Synchronization = 0x00000001,
  HostProtectionResource_SharedState = 0x00000002,
  HostProtectionResource_ExternalProcessMgmt = 0x00000004,
  HostProtectionResource_SelfAffectingProcessMgmt = 0x00000008,
  HostProtectionResource_ExternalThreading = 0x00000010,
  HostProtectionResource_SelfAffectingThreading = 0x00000020,
  HostProtectionResource_SecurityInfrastructure = 0x00000040,
  HostProtectionResource_UI = 0x00000080,
  HostProtectionResource_MayLeakOnAbort = 0x00000100,
  HostProtectionResource_All = 0x000001FF,
}

enum IsolatedStorageContainment {
  IsolatedStorageContainment_None = 0x00000000,
  IsolatedStorageContainment_DomainIsolationByUser = 0x00000010,
  IsolatedStorageContainment_ApplicationIsolationByUser = 0x00000015,
  IsolatedStorageContainment_AssemblyIsolationByUser = 0x00000020,
  IsolatedStorageContainment_DomainIsolationByMachine = 0x00000030,
  IsolatedStorageContainment_AssemblyIsolationByMachine = 0x00000040,
  IsolatedStorageContainment_ApplicationIsolationByMachine = 0x00000045,
  IsolatedStorageContainment_DomainIsolationByRoamingUser = 0x00000050,
  IsolatedStorageContainment_AssemblyIsolationByRoamingUser = 0x00000060,
  IsolatedStorageContainment_ApplicationIsolationByRoamingUser = 0x00000065,
  IsolatedStorageContainment_AdministerIsolatedStorageByUser = 0x00000070,
  IsolatedStorageContainment_UnrestrictedIsolatedStorage = 0x000000F0,
}

enum PermissionState {
  PermissionState_Unrestricted = 0x00000001,
  PermissionState_None = 0x00000000,
}

enum SecurityAction {
  SecurityAction_Demand = 0x00000002,
  SecurityAction_Assert = 0x00000003,
  SecurityAction_Deny = 0x00000004,
  SecurityAction_PermitOnly = 0x00000005,
  SecurityAction_LinkDemand = 0x00000006,
  SecurityAction_InheritanceDemand = 0x00000007,
  SecurityAction_RequestMinimum = 0x00000008,
  SecurityAction_RequestOptional = 0x00000009,
  SecurityAction_RequestRefuse = 0x0000000A,
}

enum ReflectionPermissionFlag {
  ReflectionPermissionFlag_NoFlags = 0x00000000,
  ReflectionPermissionFlag_TypeInformation = 0x00000001,
  ReflectionPermissionFlag_MemberAccess = 0x00000002,
  ReflectionPermissionFlag_ReflectionEmit = 0x00000004,
  ReflectionPermissionFlag_AllFlags = 0x00000007,
}

enum SecurityPermissionFlag {
  SecurityPermissionFlag_NoFlags = 0x00000000,
  SecurityPermissionFlag_Assertion = 0x00000001,
  SecurityPermissionFlag_UnmanagedCode = 0x00000002,
  SecurityPermissionFlag_SkipVerification = 0x00000004,
  SecurityPermissionFlag_Execution = 0x00000008,
  SecurityPermissionFlag_ControlThread = 0x00000010,
  SecurityPermissionFlag_ControlEvidence = 0x00000020,
  SecurityPermissionFlag_ControlPolicy = 0x00000040,
  SecurityPermissionFlag_SerializationFormatter = 0x00000080,
  SecurityPermissionFlag_ControlDomainPolicy = 0x00000100,
  SecurityPermissionFlag_ControlPrincipal = 0x00000200,
  SecurityPermissionFlag_ControlAppDomain = 0x00000400,
  SecurityPermissionFlag_RemotingConfiguration = 0x00000800,
  SecurityPermissionFlag_Infrastructure = 0x00001000,
  SecurityPermissionFlag_BindingRedirects = 0x00002000,
  SecurityPermissionFlag_AllFlags = 0x00003FFF,
}

enum UIPermissionWindow {
  UIPermissionWindow_NoWindows = 0x00000000,
  UIPermissionWindow_SafeSubWindows = 0x00000001,
  UIPermissionWindow_SafeTopLevelWindows = 0x00000002,
  UIPermissionWindow_AllWindows = 0x00000003,
}

enum UIPermissionClipboard {
  UIPermissionClipboard_NoClipboard = 0x00000000,
  UIPermissionClipboard_OwnClipboard = 0x00000001,
  UIPermissionClipboard_AllClipboard = 0x00000002,
}

enum KeyContainerPermissionFlags {
  KeyContainerPermissionFlags_NoFlags = 0x00000000,
  KeyContainerPermissionFlags_Create = 0x00000001,
  KeyContainerPermissionFlags_Open = 0x00000002,
  KeyContainerPermissionFlags_Delete = 0x00000004,
  KeyContainerPermissionFlags_Import = 0x00000010,
  KeyContainerPermissionFlags_Export = 0x00000020,
  KeyContainerPermissionFlags_Sign = 0x00000100,
  KeyContainerPermissionFlags_Decrypt = 0x00000200,
  KeyContainerPermissionFlags_ViewAcl = 0x00001000,
  KeyContainerPermissionFlags_ChangeAcl = 0x00002000,
  KeyContainerPermissionFlags_AllFlags = 0x00003337,
}

enum RegistryPermissionAccess {
  RegistryPermissionAccess_NoAccess = 0x00000000,
  RegistryPermissionAccess_Read = 0x00000001,
  RegistryPermissionAccess_Write = 0x00000002,
  RegistryPermissionAccess_Create = 0x00000004,
  RegistryPermissionAccess_AllAccess = 0x00000007,
}

enum HostSecurityManagerOptions {
  HostSecurityManagerOptions_None = 0x00000000,
  HostSecurityManagerOptions_HostAppDomainEvidence = 0x00000001,
  HostSecurityManagerOptions_HostPolicyLevel = 0x00000002,
  HostSecurityManagerOptions_HostAssemblyEvidence = 0x00000004,
  HostSecurityManagerOptions_HostDetermineApplicationTrust = 0x00000008,
  HostSecurityManagerOptions_HostResolvePolicy = 0x00000010,
  HostSecurityManagerOptions_AllFlags = 0x0000001F,
}

enum PolicyLevelType {
  PolicyLevelType_User = 0x00000000,
  PolicyLevelType_Machine = 0x00000001,
  PolicyLevelType_Enterprise = 0x00000002,
  PolicyLevelType_AppDomain = 0x00000003,
}

enum SecurityZone {
  SecurityZone_MyComputer = 0x00000000,
  SecurityZone_Intranet = 0x00000001,
  SecurityZone_Trusted = 0x00000002,
  SecurityZone_Internet = 0x00000003,
  SecurityZone_Untrusted = 0x00000004,
  SecurityZone_NoZone = 0xFFFFFFFF,
}

enum WellKnownObjectMode {
  WellKnownObjectMode_Singleton = 0x00000001,
  WellKnownObjectMode_SingleCall = 0x00000002,
}

enum ActivatorLevel {
  ActivatorLevel_Construction = 0x00000004,
  ActivatorLevel_Context = 0x00000008,
  ActivatorLevel_AppDomain = 0x0000000C,
  ActivatorLevel_Process = 0x00000010,
  ActivatorLevel_Machine = 0x00000014,
}

enum ServerProcessing {
  ServerProcessing_Complete = 0x00000000,
  ServerProcessing_OneWay = 0x00000001,
  ServerProcessing_Async = 0x00000002,
}

enum LeaseState {
  LeaseState_Null = 0x00000000,
  LeaseState_Initial = 0x00000001,
  LeaseState_Active = 0x00000002,
  LeaseState_Renewing = 0x00000003,
  LeaseState_Expired = 0x00000004,
}

enum SoapOption {
  SoapOption_None = 0x00000000,
  SoapOption_AlwaysIncludeTypes = 0x00000001,
  SoapOption_XsdString = 0x00000002,
  SoapOption_EmbedAll = 0x00000004,
  SoapOption_Option1 = 0x00000008,
  SoapOption_Option2 = 0x00000010,
}

enum XmlFieldOrderOption {
  XmlFieldOrderOption_All = 0x00000000,
  XmlFieldOrderOption_Sequence = 0x00000001,
  XmlFieldOrderOption_Choice = 0x00000002,
}

enum CustomErrorsModes {
  CustomErrorsModes_On = 0x00000000,
  CustomErrorsModes_Off = 0x00000001,
  CustomErrorsModes_RemoteOnly = 0x00000002,
}

enum IsolatedStorageScope {
  IsolatedStorageScope_None = 0x00000000,
  IsolatedStorageScope_User = 0x00000001,
  IsolatedStorageScope_Domain = 0x00000002,
  IsolatedStorageScope_Assembly = 0x00000004,
  IsolatedStorageScope_Roaming = 0x00000008,
  IsolatedStorageScope_Machine = 0x00000010,
  IsolatedStorageScope_Application = 0x00000020,
}

enum FormatterTypeStyle {
  FormatterTypeStyle_TypesWhenNeeded = 0x00000000,
  FormatterTypeStyle_TypesAlways = 0x00000001,
  FormatterTypeStyle_XsdString = 0x00000002,
}

enum FormatterAssemblyStyle {
  FormatterAssemblyStyle_Simple = 0x00000000,
  FormatterAssemblyStyle_Full = 0x00000001,
}

enum TypeFilterLevel {
  TypeFilterLevel_Low = 0x00000002,
  TypeFilterLevel_Full = 0x00000003,
}

enum AssemblyBuilderAccess {
  AssemblyBuilderAccess_Run = 0x00000001,
  AssemblyBuilderAccess_Save = 0x00000002,
  AssemblyBuilderAccess_RunAndSave = 0x00000003,
  AssemblyBuilderAccess_ReflectionOnly = 0x00000006,
  AssemblyBuilderAccess_RunAndCollect = 0x00000009,
}

enum PEFileKinds {
  PEFileKinds_Dll = 0x00000001,
  PEFileKinds_ConsoleApplication = 0x00000002,
  PEFileKinds_WindowApplication = 0x00000003,
}

enum OpCodeType {
  OpCodeType_Annotation = 0x00000000,
  OpCodeType_Macro = 0x00000001,
  OpCodeType_Nternal = 0x00000002,
  OpCodeType_Objmodel = 0x00000003,
  OpCodeType_Prefix = 0x00000004,
  OpCodeType_Primitive = 0x00000005,
}

enum StackBehaviour {
  StackBehaviour_Pop0 = 0x00000000,
  StackBehaviour_Pop1 = 0x00000001,
  StackBehaviour_Pop1_pop1 = 0x00000002,
  StackBehaviour_Popi = 0x00000003,
  StackBehaviour_Popi_pop1 = 0x00000004,
  StackBehaviour_Popi_popi = 0x00000005,
  StackBehaviour_Popi_popi8 = 0x00000006,
  StackBehaviour_Popi_popi_popi = 0x00000007,
  StackBehaviour_Popi_popr4 = 0x00000008,
  StackBehaviour_Popi_popr8 = 0x00000009,
  StackBehaviour_Popref = 0x0000000A,
  StackBehaviour_Popref_pop1 = 0x0000000B,
  StackBehaviour_Popref_popi = 0x0000000C,
  StackBehaviour_Popref_popi_popi = 0x0000000D,
  StackBehaviour_Popref_popi_popi8 = 0x0000000E,
  StackBehaviour_Popref_popi_popr4 = 0x0000000F,
  StackBehaviour_Popref_popi_popr8 = 0x00000010,
  StackBehaviour_Popref_popi_popref = 0x00000011,
  StackBehaviour_Push0 = 0x00000012,
  StackBehaviour_Push1 = 0x00000013,
  StackBehaviour_Push1_push1 = 0x00000014,
  StackBehaviour_Pushi = 0x00000015,
  StackBehaviour_Pushi8 = 0x00000016,
  StackBehaviour_Pushr4 = 0x00000017,
  StackBehaviour_Pushr8 = 0x00000018,
  StackBehaviour_Pushref = 0x00000019,
  StackBehaviour_Varpop = 0x0000001A,
  StackBehaviour_Varpush = 0x0000001B,
  StackBehaviour_Popref_popi_pop1 = 0x0000001C,
}

enum OperandType {
  OperandType_InlineBrTarget = 0x00000000,
  OperandType_InlineField = 0x00000001,
  OperandType_InlineI = 0x00000002,
  OperandType_InlineI8 = 0x00000003,
  OperandType_InlineMethod = 0x00000004,
  OperandType_InlineNone = 0x00000005,
  OperandType_InlinePhi = 0x00000006,
  OperandType_InlineR = 0x00000007,
  OperandType_InlineSig = 0x00000009,
  OperandType_InlineString = 0x0000000A,
  OperandType_InlineSwitch = 0x0000000B,
  OperandType_InlineTok = 0x0000000C,
  OperandType_InlineType = 0x0000000D,
  OperandType_InlineVar = 0x0000000E,
  OperandType_ShortInlineBrTarget = 0x0000000F,
  OperandType_ShortInlineI = 0x00000010,
  OperandType_ShortInlineR = 0x00000011,
  OperandType_ShortInlineVar = 0x00000012,
}

enum FlowControl {
  FlowControl_Branch = 0x00000000,
  FlowControl_Break = 0x00000001,
  FlowControl_Call = 0x00000002,
  FlowControl_Cond_Branch = 0x00000003,
  FlowControl_Meta = 0x00000004,
  FlowControl_Next = 0x00000005,
  FlowControl_Phi = 0x00000006,
  FlowControl_Return = 0x00000007,
  FlowControl_Throw = 0x00000008,
}

enum PackingSize {
  PackingSize_Unspecified = 0x00000000,
  PackingSize_Size1 = 0x00000001,
  PackingSize_Size2 = 0x00000002,
  PackingSize_Size4 = 0x00000004,
  PackingSize_Size8 = 0x00000008,
  PackingSize_Size16 = 0x00000010,
  PackingSize_Size32 = 0x00000020,
  PackingSize_Size64 = 0x00000040,
  PackingSize_Size128 = 0x00000080,
}

enum AssemblyHashAlgorithm {
  AssemblyHashAlgorithm_None = 0x00000000,
  AssemblyHashAlgorithm_MD5 = 0x00008003,
  AssemblyHashAlgorithm_SHA1 = 0x00008004,
}

enum AssemblyVersionCompatibility {
  AssemblyVersionCompatibility_SameMachine = 0x00000001,
  AssemblyVersionCompatibility_SameProcess = 0x00000002,
  AssemblyVersionCompatibility_SameDomain = 0x00000003,
}

enum CipherMode {
  CipherMode_CBC = 0x00000001,
  CipherMode_ECB = 0x00000002,
  CipherMode_OFB = 0x00000003,
  CipherMode_CFB = 0x00000004,
  CipherMode_CTS = 0x00000005,
}

enum PaddingMode {
  PaddingMode_None = 0x00000001,
  PaddingMode_PKCS7 = 0x00000002,
  PaddingMode_Zeros = 0x00000003,
  PaddingMode_ANSIX923 = 0x00000004,
  PaddingMode_ISO10126 = 0x00000005,
}

enum FromBase64TransformMode {
  FromBase64TransformMode_IgnoreWhiteSpaces = 0x00000000,
  FromBase64TransformMode_DoNotIgnoreWhiteSpaces = 0x00000001,
}

enum CspProviderFlags {
  CspProviderFlags_NoFlags = 0x00000000,
  CspProviderFlags_UseMachineKeyStore = 0x00000001,
  CspProviderFlags_UseDefaultKeyContainer = 0x00000002,
  CspProviderFlags_UseNonExportableKey = 0x00000004,
  CspProviderFlags_UseExistingKey = 0x00000008,
  CspProviderFlags_UseArchivableKey = 0x00000010,
  CspProviderFlags_UseUserProtectedKey = 0x00000020,
  CspProviderFlags_NoPrompt = 0x00000040,
  CspProviderFlags_CreateEphemeralKey = 0x00000080,
}

enum CryptoStreamMode {
  CryptoStreamMode_Read = 0x00000000,
  CryptoStreamMode_Write = 0x00000001,
}

enum KeyNumber {
  KeyNumber_Exchange = 0x00000001,
  KeyNumber_Signature = 0x00000002,
}

enum X509ContentType {
  X509ContentType_Unknown = 0x00000000,
  X509ContentType_Cert = 0x00000001,
  X509ContentType_SerializedCert = 0x00000002,
  X509ContentType_Pfx = 0x00000003,
  X509ContentType_Pkcs12 = 0x00000003,
  X509ContentType_SerializedStore = 0x00000004,
  X509ContentType_Pkcs7 = 0x00000005,
  X509ContentType_Authenticode = 0x00000006,
}

enum X509KeyStorageFlags {
  X509KeyStorageFlags_DefaultKeySet = 0x00000000,
  X509KeyStorageFlags_UserKeySet = 0x00000001,
  X509KeyStorageFlags_MachineKeySet = 0x00000002,
  X509KeyStorageFlags_Exportable = 0x00000004,
  X509KeyStorageFlags_UserProtected = 0x00000008,
  X509KeyStorageFlags_PersistKeySet = 0x00000010,
}
...
interface IEqualityComparer : IDispatch {
  ...
  /*[id(0x60020001)]*/ int GetHashCode(VARIANT obj, out int pRetVal);
}
...
interface _AppDomain : IUnknown {
  ...
  /*[id(0x60010024)]*/ int CreateInstance_2(wchar* AssemblyName, wchar* typeName,  activationAttributes, out _ObjectHandle pRetVal);
  /*[id(0x60010025)]*/ int CreateInstanceFrom_2(wchar* assemblyFile, wchar* typeName,  activationAttributes, out _ObjectHandle pRetVal);
  /*[id(0x60010026)]*/ int CreateInstance_3(wchar* AssemblyName, wchar* typeName, short ignoreCase, BindingFlags bindingAttr, _Binder Binder,  args, _CultureInfo culture,  activationAttributes, _Evidence securityAttributes, out _ObjectHandle pRetVal);
  /*[id(0x60010027)]*/ int CreateInstanceFrom_3(wchar* assemblyFile, wchar* typeName, short ignoreCase, BindingFlags bindingAttr, _Binder Binder,  args, _CultureInfo culture,  activationAttributes, _Evidence securityAttributes, out _ObjectHandle pRetVal);
  ...
  /*[id(0x6001002A)]*/ int Load_3( rawAssembly, out _Assembly pRetVal);
  /*[id(0x6001002B)]*/ int Load_4( rawAssembly,  rawSymbolStore, out _Assembly pRetVal);
  /*[id(0x6001002C)]*/ int Load_5( rawAssembly,  rawSymbolStore, _Evidence securityEvidence, out _Assembly pRetVal);
  ...
  /*[id(0x60010031)]*/ int ExecuteAssembly_3(wchar* assemblyFile, _Evidence assemblySecurity,  args, out int pRetVal);
  ...
  /*[id(0x60010036)]*/ int GetAssemblies(out  pRetVal);
...
interface ICustomFormatter : IDispatch {
  ...
  /*[id(0x60020000)]*/ int format(wchar* format, VARIANT arg, IFormatProvider formatProvider, out wchar* pRetVal);
}
...
interface ICustomAttributeProvider : IDispatch {
  ...
  /*[id(0x60020000)]*/ int GetCustomAttributes(_Type attributeType, short inherit, out  pRetVal);
  /*[id(0x60020001)]*/ int GetCustomAttributes_2(short inherit, out  pRetVal);
...
interface _MemberInfo : IUnknown {
  ...
  /*[id(0x6001000C)]*/ int GetCustomAttributes(_Type attributeType, short inherit, out  pRetVal);
  /*[id(0x6001000D)]*/ int GetCustomAttributes_2(short inherit, out  pRetVal);
...
interface _Type : IUnknown {
  ...
  /*[id(0x60010018)]*/ int GetConstructors(BindingFlags bindingAttr, out  pRetVal);
  /*[id(0x60010019)]*/ int GetInterface(wchar* name, short ignoreCase, out _Type pRetVal);
  /*[id(0x6001001A)]*/ int GetInterfaces(out  pRetVal);
  /*[id(0x6001001B)]*/ int FindInterfaces(_TypeFilter filter, VARIANT filterCriteria, out  pRetVal);
  /*[id(0x6001001C)]*/ int GetEvent(wchar* name, BindingFlags bindingAttr, out _EventInfo pRetVal);
  /*[id(0x6001001D)]*/ int GetEvents(out  pRetVal);
  /*[id(0x6001001E)]*/ int GetEvents_2(BindingFlags bindingAttr, out  pRetVal);
  /*[id(0x6001001F)]*/ int GetNestedTypes(BindingFlags bindingAttr, out  pRetVal);
  /*[id(0x60010020)]*/ int GetNestedType(wchar* name, BindingFlags bindingAttr, out _Type pRetVal);
  /*[id(0x60010021)]*/ int GetMember(wchar* name, MemberTypes Type, BindingFlags bindingAttr, out  pRetVal);
  /*[id(0x60010022)]*/ int GetDefaultMembers(out  pRetVal);
  /*[id(0x60010023)]*/ int FindMembers(MemberTypes MemberType, BindingFlags bindingAttr, _MemberFilter filter, VARIANT filterCriteria, out  pRetVal);
  ...
  /*[id(0x60010029)]*/ int GetMethod(wchar* name, BindingFlags bindingAttr, _Binder Binder,  types,  modifiers, out _MethodInfo pRetVal);
  /*[id(0x6001002A)]*/ int GetMethod_2(wchar* name, BindingFlags bindingAttr, out _MethodInfo pRetVal);
  /*[id(0x6001002B)]*/ int GetMethods(BindingFlags bindingAttr, out  pRetVal);
  /*[id(0x6001002C)]*/ int GetField(wchar* name, BindingFlags bindingAttr, out _FieldInfo pRetVal);
  /*[id(0x6001002D)]*/ int GetFields(BindingFlags bindingAttr, out  pRetVal);
  /*[id(0x6001002E)]*/ int GetProperty(wchar* name, BindingFlags bindingAttr, out _PropertyInfo pRetVal);
  /*[id(0x6001002F)]*/ int GetProperty_2(wchar* name, BindingFlags bindingAttr, _Binder Binder, _Type returnType,  types,  modifiers, out _PropertyInfo pRetVal);
  /*[id(0x60010030)]*/ int GetProperties(BindingFlags bindingAttr, out  pRetVal);
  /*[id(0x60010031)]*/ int GetMember_2(wchar* name, BindingFlags bindingAttr, out  pRetVal);
  /*[id(0x60010032)]*/ int GetMembers(BindingFlags bindingAttr, out  pRetVal);
  /*[id(0x60010033)]*/ int InvokeMember(wchar* name, BindingFlags invokeAttr, _Binder Binder, VARIANT Target,  args,  modifiers, _CultureInfo culture,  namedParameters, out VARIANT pRetVal);
  /*[id(0x60010034)]*/ int get_UnderlyingSystemType(out _Type pRetVal);
  /*[id(0x60010035)]*/ int InvokeMember_2(wchar* name, BindingFlags invokeAttr, _Binder Binder, VARIANT Target,  args, _CultureInfo culture, out VARIANT pRetVal);
  /*[id(0x60010036)]*/ int InvokeMember_3(wchar* name, BindingFlags invokeAttr, _Binder Binder, VARIANT Target,  args, out VARIANT pRetVal);
  /*[id(0x60010037)]*/ int GetConstructor(BindingFlags bindingAttr, _Binder Binder, CallingConventions callConvention,  types,  modifiers, out _ConstructorInfo pRetVal);
  /*[id(0x60010038)]*/ int GetConstructor_2(BindingFlags bindingAttr, _Binder Binder,  types,  modifiers, out _ConstructorInfo pRetVal);
  /*[id(0x60010039)]*/ int GetConstructor_3( types, out _ConstructorInfo pRetVal);
  /*[id(0x6001003A)]*/ int GetConstructors_2(out  pRetVal);
  /*[id(0x6001003B)]*/ int get_TypeInitializer(out _ConstructorInfo pRetVal);
  /*[id(0x6001003C)]*/ int GetMethod_3(wchar* name, BindingFlags bindingAttr, _Binder Binder, CallingConventions callConvention,  types,  modifiers, out _MethodInfo pRetVal);
  /*[id(0x6001003D)]*/ int GetMethod_4(wchar* name,  types,  modifiers, out _MethodInfo pRetVal);
  /*[id(0x6001003E)]*/ int GetMethod_5(wchar* name,  types, out _MethodInfo pRetVal);
  /*[id(0x6001003F)]*/ int GetMethod_6(wchar* name, out _MethodInfo pRetVal);
  /*[id(0x60010040)]*/ int GetMethods_2(out  pRetVal);
  /*[id(0x60010041)]*/ int GetField_2(wchar* name, out _FieldInfo pRetVal);
  /*[id(0x60010042)]*/ int GetFields_2(out  pRetVal);
  ...
  /*[id(0x60010045)]*/ int GetProperty_3(wchar* name, _Type returnType,  types,  modifiers, out _PropertyInfo pRetVal);
  /*[id(0x60010046)]*/ int GetProperty_4(wchar* name, _Type returnType,  types, out _PropertyInfo pRetVal);
  /*[id(0x60010047)]*/ int GetProperty_5(wchar* name,  types, out _PropertyInfo pRetVal);
  ...
  /*[id(0x6001004A)]*/ int GetProperties_2(out  pRetVal);
  /*[id(0x6001004B)]*/ int GetNestedTypes_2(out  pRetVal);
  /*[id(0x6001004C)]*/ int GetNestedType_2(wchar* name, out _Type pRetVal);
  /*[id(0x6001004D)]*/ int GetMember_3(wchar* name, out  pRetVal);
  /*[id(0x6001004E)]*/ int GetMembers_2(out  pRetVal);
...
interface IReflect : IDispatch {
  ...
  /*[id(0x60020000)]*/ int GetMethod(wchar* name, BindingFlags bindingAttr, _Binder Binder,  types,  modifiers, out _MethodInfo pRetVal);
  /*[id(0x60020001)]*/ int GetMethod_2(wchar* name, BindingFlags bindingAttr, out _MethodInfo pRetVal);
  /*[id(0x60020002)]*/ int GetMethods(BindingFlags bindingAttr, out  pRetVal);
  /*[id(0x60020003)]*/ int GetField(wchar* name, BindingFlags bindingAttr, out _FieldInfo pRetVal);
  /*[id(0x60020004)]*/ int GetFields(BindingFlags bindingAttr, out  pRetVal);
  /*[id(0x60020005)]*/ int GetProperty(wchar* name, BindingFlags bindingAttr, out _PropertyInfo pRetVal);
  /*[id(0x60020006)]*/ int GetProperty_2(wchar* name, BindingFlags bindingAttr, _Binder Binder, _Type returnType,  types,  modifiers, out _PropertyInfo pRetVal);
  /*[id(0x60020007)]*/ int GetProperties(BindingFlags bindingAttr, out  pRetVal);
  /*[id(0x60020008)]*/ int GetMember(wchar* name, BindingFlags bindingAttr, out  pRetVal);
  /*[id(0x60020009)]*/ int GetMembers(BindingFlags bindingAttr, out  pRetVal);
  /*[id(0x6002000A)]*/ int InvokeMember(wchar* name, BindingFlags invokeAttr, _Binder Binder, VARIANT Target,  args,  modifiers, _CultureInfo culture,  namedParameters, out VARIANT pRetVal);
...
interface IHashCodeProvider : IDispatch {
  ...
  /*[id(0x60020000)]*/ int GetHashCode(VARIANT obj, out int pRetVal);
}
...
interface ISymbolDocument : IDispatch {
  ...
  /*[id(0x60020005)]*/ int GetCheckSum(out  pRetVal);
  ...
  /*[id(0x60020009)]*/ int GetSourceRange(int startLine, int startColumn, int endLine, int endColumn, out  pRetVal);
}

interface ISymbolDocumentWriter : IDispatch {
  mixin(uuid("fa682f24-3a3c-390d-b8a2-96f1106f4b37"));
  /*[id(0x60020000)]*/ int SetSource( Source);
  /*[id(0x60020001)]*/ int SetCheckSum(GUID algorithmId,  checkSum);
}
...
interface ISymbolMethod : IDispatch {
  ...
  /*[id(0x60020002)]*/ int GetSequencePoints( offsets,  documents,  lines,  columns,  endLines,  endColumns);
  ...
  /*[id(0x60020006)]*/ int GetRanges(ISymbolDocument document, int line, int column, out  pRetVal);
  /*[id(0x60020007)]*/ int GetParameters(out  pRetVal);
  /*[id(0x60020008)]*/ int GetNamespace(out ISymbolNamespace pRetVal);
  /*[id(0x60020009)]*/ int GetSourceStartEnd( docs,  lines,  columns, out short pRetVal);
}
...
interface ISymbolNamespace : IDispatch {
  ...
  /*[id(0x60020001)]*/ int GetNamespaces(out  pRetVal);
  /*[id(0x60020002)]*/ int GetVariables(out  pRetVal);
}
...
interface ISymbolReader : IDispatch {
  ...
  /*[id(0x60020001)]*/ int GetDocuments(out  pRetVal);
  ...
  /*[id(0x60020005)]*/ int GetVariables(SymbolToken parent, out  pRetVal);
  /*[id(0x60020006)]*/ int GetGlobalVariables(out  pRetVal);
  /*[id(0x60020007)]*/ int GetMethodFromDocumentPosition(ISymbolDocument document, int line, int column, out ISymbolMethod pRetVal);
  /*[id(0x60020008)]*/ int GetSymAttribute(SymbolToken parent, wchar* name, out  pRetVal);
  /*[id(0x60020009)]*/ int GetNamespaces(out  pRetVal);
}
...
interface ISymbolScope : IDispatch {
  ...
  /*[id(0x60020002)]*/ int GetChildren(out  pRetVal);
  /*[id(0x60020003)]*/ int get_StartOffset(out int pRetVal);
  /*[id(0x60020004)]*/ int get_EndOffset(out int pRetVal);
  /*[id(0x60020005)]*/ int GetLocals(out  pRetVal);
  /*[id(0x60020006)]*/ int GetNamespaces(out  pRetVal);
}
...
interface ISymbolVariable : IDispatch {
  ...
  /*[id(0x60020002)]*/ int GetSignature(out  pRetVal);
...
interface ISymbolWriter : IDispatch {
  ...
  /*[id(0x60020005)]*/ int DefineSequencePoints(ISymbolDocumentWriter document,  offsets,  lines,  columns,  endLines,  endColumns);
  ...
  /*[id(0x60020009)]*/ int DefineLocalVariable(wchar* name, FieldAttributes Attributes,  signature, SymAddressKind addrKind, int addr1, int addr2, int addr3, int StartOffset, int EndOffset);
  ...
  /*[id(0x6002000B)]*/ int DefineField(SymbolToken parent, wchar* name, FieldAttributes Attributes,  signature, SymAddressKind addrKind, int addr1, int addr2, int addr3);
  /*[id(0x6002000C)]*/ int DefineGlobalVariable(wchar* name, FieldAttributes Attributes,  signature, SymAddressKind addrKind, int addr1, int addr2, int addr3);
  /*[id(0x6002000D)]*/ int Close();
  /*[id(0x6002000E)]*/ int SetSymAttribute(SymbolToken parent, wchar* name,  data);
...
interface _Assembly : IDispatch {
  ...
  /*[id(0x6002000C)]*/ int GetExportedTypes(out  pRetVal);
  /*[id(0x6002000D)]*/ int GetTypes(out  pRetVal);
  ...
  /*[id(0x60020011)]*/ int GetFiles(out  pRetVal);
  /*[id(0x60020012)]*/ int GetFiles_2(short getResourceModules, out  pRetVal);
  /*[id(0x60020013)]*/ int GetManifestResourceNames(out  pRetVal);
  ...
  /*[id(0x60020017)]*/ int GetCustomAttributes(_Type attributeType, short inherit, out  pRetVal);
  /*[id(0x60020018)]*/ int GetCustomAttributes_2(short inherit, out  pRetVal);
  ...
  /*[id(0x60020020)]*/ int LoadModule(wchar* moduleName,  rawModule, out _Module pRetVal);
  /*[id(0x60020021)]*/ int LoadModule_2(wchar* moduleName,  rawModule,  rawSymbolStore, out _Module pRetVal);
  ...
  /*[id(0x60020024)]*/ int CreateInstance_3(wchar* typeName, short ignoreCase, BindingFlags bindingAttr, _Binder Binder,  args, _CultureInfo culture,  activationAttributes, out VARIANT pRetVal);
  /*[id(0x60020025)]*/ int GetLoadedModules(out  pRetVal);
  /*[id(0x60020026)]*/ int GetLoadedModules_2(short getResourceModules, out  pRetVal);
  /*[id(0x60020027)]*/ int GetModules(out  pRetVal);
  /*[id(0x60020028)]*/ int GetModules_2(short getResourceModules, out  pRetVal);
  /*[id(0x60020029)]*/ int GetModule(wchar* name, out _Module pRetVal);
  /*[id(0x6002002A)]*/ int GetReferencedAssemblies(out  pRetVal);
...
interface _MethodBase : IUnknown {
  ...
  /*[id(0x6001000D)]*/ int GetCustomAttributes_2(short inherit, out  pRetVal);
  /*[id(0x6001000E)]*/ int IsDefined(_Type attributeType, short inherit, out short pRetVal);
  /*[id(0x6001000F)]*/ int GetParameters(out  pRetVal);
  ...
  /*[id(0x60010014)]*/ int Invoke_2(VARIANT obj, BindingFlags invokeAttr, _Binder Binder,  parameters, _CultureInfo culture, out VARIANT pRetVal);
  ...
  /*[id(0x60010022)]*/ int Invoke_3(VARIANT obj,  parameters, out VARIANT pRetVal);
}
...
interface _ConstructorInfo : IUnknown {
  ...
  /*[id(0x60010021)]*/ int get_IsConstructor(out short pRetVal);
  /*[id(0x60010022)]*/ int Invoke_3(VARIANT obj,  parameters, out VARIANT pRetVal);
  /*[id(0x60010023)]*/ int Invoke_4(BindingFlags invokeAttr, _Binder Binder,  parameters, _CultureInfo culture, out VARIANT pRetVal);
  /*[id(0x60010024)]*/ int Invoke_5( parameters, out VARIANT pRetVal);
}
...
interface _FieldInfo : IUnknown {
  ...
  /*[id(0x60010010)]*/ int GetValue(VARIANT obj, out VARIANT pRetVal);
  /*[id(0x60010011)]*/ int GetValueDirect(VARIANT obj, out VARIANT pRetVal);
  /*[id(0x60010012)]*/ int SetValue(VARIANT obj, VARIANT value, BindingFlags invokeAttr, _Binder Binder, _CultureInfo culture);
  /*[id(0x60010013)]*/ int SetValueDirect(VARIANT obj, VARIANT value);
  ...
  /*[id(0x60010016)]*/ int SetValue_2(VARIANT obj, VARIANT value);
...
interface _PropertyInfo : IUnknown {
  ...
  /*[id(0x60010010)]*/ int GetValue(VARIANT obj,  index, out VARIANT pRetVal);
  /*[id(0x60010011)]*/ int GetValue_2(VARIANT obj, BindingFlags invokeAttr, _Binder Binder,  index, _CultureInfo culture, out VARIANT pRetVal);
  /*[id(0x60010012)]*/ int SetValue(VARIANT obj, VARIANT value,  index);
  /*[id(0x60010013)]*/ int SetValue_2(VARIANT obj, VARIANT value, BindingFlags invokeAttr, _Binder Binder,  index, _CultureInfo culture);
  /*[id(0x60010014)]*/ int GetAccessors(short nonPublic, out  pRetVal);
  ...
  /*[id(0x60010017)]*/ int GetIndexParameters(out  pRetVal);
  ...
  /*[id(0x6001001B)]*/ int GetAccessors_2(out  pRetVal);
...
interface ISerializationSurrogate : IDispatch {
  ...
  /*[id(0x60020000)]*/ int GetObjectData(VARIANT obj, _SerializationInfo info, StreamingContext Context);
  /*[id(0x60020001)]*/ int SetObjectData(VARIANT obj, _SerializationInfo info, StreamingContext Context, ISurrogateSelector selector, out VARIANT pRetVal);
}
...
interface IResourceWriter : IDispatch {
  ...
  /*[id(0x60020002)]*/ int AddResource_3(wchar* name,  value);
...
interface IMembershipCondition : IDispatch {
  ...
  /*[id(0x00000000)]*/ int get_ToString(out wchar* pRetVal);
  /*[id(0x60020003)]*/ int Equals(VARIANT obj, out short pRetVal);
}
...
interface IRegistrationServices : IDispatch {
  ...
  /*[id(0x60020002)]*/ int GetRegistrableTypesInAssembly(_Assembly Assembly, out  pRetVal);
...
interface ITypeLibConverter : IUnknown {
  ...
  /*[id(0x60010000)]*/ int ConvertTypeLibToAssembly(IUnknown typeLib, wchar* asmFileName, TypeLibImporterFlags flags, ITypeLibImporterNotifySink notifySink,  publicKey, _StrongNameKeyPair keyPair, wchar* asmNamespace, _Version asmVersion, out _AssemblyBuilder pRetVal);
  ...
  /*[id(0x60010003)]*/ int ConvertTypeLibToAssembly_2(IUnknown typeLib, wchar* asmFileName, int flags, ITypeLibImporterNotifySink notifySink,  publicKey, _StrongNameKeyPair keyPair, short unsafeInterfaces, out _AssemblyBuilder pRetVal);
}

interface ITypeLibExporterNameProvider : IUnknown {
  mixin(uuid("fa1f3615-acb9-486d-9eac-1bef87e36b09"));
  /*[id(0x60010000)]*/ int GetNames(out  pRetVal);
}
...
interface IChannelReceiver : IDispatch {
  ...
  /*[id(0x60020001)]*/ int GetUrlsForUri(wchar* objectURI, out  pRetVal);
...
interface IMethodMessage : IDispatch {
  ...
  /*[id(0x60020007)]*/ int get_args(out  pRetVal);
...
interface IMethodCallMessage : IDispatch {
  ...
  /*[id(0x60020003)]*/ int get_InArgs(out  pRetVal);
}
...
interface IConstructionCallMessage : IDispatch {
  ...
  /*[id(0x60020002)]*/ int get_CallSiteActivationAttributes(out  pRetVal);
...
interface IMethodReturnMessage : IDispatch {
  ...
  /*[id(0x60020003)]*/ int get_OutArgs(out  pRetVal);
...
interface IChannelDataStore : IDispatch {
  ...
  /*[id(0x60020000)]*/ int get_ChannelUris(out  pRetVal);
  /*[id(0x00000000)]*/ int get_Item(VARIANT key, out VARIANT pRetVal);
  /*[id(0x00000000)]*/ int putref_Item(VARIANT key, VARIANT pRetVal);
}
...
interface IContributeEnvoySink : IDispatch {
  ...
  /*[id(0x60020000)]*/ int GetEnvoySink(_MarshalByRefObject obj, IMessageSink NextSink, out IMessageSink pRetVal);
}

interface IContributeObjectSink : IDispatch {
  mixin(uuid("6a5d38bc-2789-3546-81a1-f10c0fb59366"));
  /*[id(0x60020000)]*/ int GetObjectSink(_MarshalByRefObject obj, IMessageSink NextSink, out IMessageSink pRetVal);
}
...
interface ILease : IDispatch {
  ...
  /*[id(0x60020000)]*/ int Register(ISponsor obj, TimeSpan renewalTime);
  /*[id(0x60020001)]*/ int Register_2(ISponsor obj);
  /*[id(0x60020002)]*/ int Unregister(ISponsor obj);
...
interface IRemotingFormatter : IDispatch {
  ...
  /*[id(0x60020001)]*/ int Serialize(_Stream serializationStream, VARIANT graph,  headers);
}

interface IFieldInfo : IDispatch {
  mixin(uuid("cc18fd4d-aa2d-3ab4-9848-584bbae4ab44"));
  /*[id(0x60020000)]*/ int get_FieldNames(out  pRetVal);
  /*[id(0x60020000)]*/ int put_FieldNames( pRetVal);
  /*[id(0x60020002)]*/ int get_FieldTypes(out  pRetVal);
  /*[id(0x60020002)]*/ int put_FieldTypes( pRetVal);
}
...
interface IChannelInfo : IDispatch {
  ...
  /*[id(0x60020000)]*/ int get_ChannelData(out  pRetVal);
  /*[id(0x60020000)]*/ int put_ChannelData( pRetVal);
}
...
interface ITrackingHandler : IDispatch {
  ...
  /*[id(0x60020000)]*/ int MarshaledObject(VARIANT obj, _ObjRef or);
  /*[id(0x60020001)]*/ int UnmarshaledObject(VARIANT obj, _ObjRef or);
  /*[id(0x60020002)]*/ int DisconnectedObject(VARIANT obj);
}
...
interface ISoapMessage : IDispatch {
  ...
  /*[id(0x60020000)]*/ int get_ParamNames(out  pRetVal);
  /*[id(0x60020000)]*/ int put_ParamNames( pRetVal);
  /*[id(0x60020002)]*/ int get_ParamValues(out  pRetVal);
  /*[id(0x60020002)]*/ int put_ParamValues( pRetVal);
  /*[id(0x60020004)]*/ int get_ParamTypes(out  pRetVal);
  /*[id(0x60020004)]*/ int put_ParamTypes( pRetVal);
  ...
  /*[id(0x6002000A)]*/ int get_headers(out  pRetVal);
  /*[id(0x6002000A)]*/ int put_headers( pRetVal);
}
...
interface ICryptoTransform : IDispatch {
  ...
  /*[id(0x60020004)]*/ int TransformBlock( inputBuffer, int inputOffset, int inputCount,  outputBuffer, int outputOffset, out int pRetVal);
  /*[id(0x60020005)]*/ int TransformFinalBlock( inputBuffer, int inputOffset, int inputCount, out  pRetVal);
}
...
interface ICspAsymmetricAlgorithm : IDispatch {
  ...
  /*[id(0x60020001)]*/ int ExportCspBlob(short includePrivateParameters, out  pRetVal);
  /*[id(0x60020002)]*/ int ImportCspBlob( rawData);
}
...
interface _Delegate : IDispatch {
  ...
  /*[id(0x60020002)]*/ int GetHashCode(out int pRetVal);
  /*[id(0x60020003)]*/ int GetType(out _Type pRetVal);
  /*[id(0x60020004)]*/ int GetInvocationList(out  pRetVal);
  ...
  /*[id(0x60020007)]*/ int DynamicInvoke( args, out VARIANT pRetVal);
...
interface _StackOverflowException : IDispatch {
...
interface _ArgumentException : IDispatch {
  mixin(uuid("4db2c2b7-cbc2-3185-b966-875d4625b1a8"));
}

interface _ArgumentNullException : IDispatch {
  mixin(uuid("c991949b-e623-3f24-885c-bbb01ff43564"));
}

interface _ArgumentOutOfRangeException : IDispatch {
...
interface _BadImageFormatException : IDispatch {
...
interface _Binder : IDispatch {
  ...
  /*[id(0x60020002)]*/ int GetHashCode(out int pRetVal);
  /*[id(0x60020003)]*/ int GetType(out _Type pRetVal);
  /*[id(0x60020004)]*/ int BindToMethod(BindingFlags bindingAttr,  match, ref  args,  modifiers, _CultureInfo culture,  names, out VARIANT state, out _MethodBase pRetVal);
  /*[id(0x60020005)]*/ int BindToField(BindingFlags bindingAttr,  match, VARIANT value, _CultureInfo culture, out _FieldInfo pRetVal);
  /*[id(0x60020006)]*/ int SelectMethod(BindingFlags bindingAttr,  match,  types,  modifiers, out _MethodBase pRetVal);
  /*[id(0x60020007)]*/ int SelectProperty(BindingFlags bindingAttr,  match, _Type returnType,  indexes,  modifiers, out _PropertyInfo pRetVal);
  /*[id(0x60020008)]*/ int ChangeType(VARIANT value, _Type Type, _CultureInfo culture, out VARIANT pRetVal);
  /*[id(0x60020009)]*/ int ReorderArgumentArray(ref  args, VARIANT state);
}
...
interface _FormatException : IDispatch {
...
interface _InvalidCastException : IDispatch {
  mixin(uuid("fa047cbd-9ba5-3a13-9b1f-6694d622cd76"));
}

interface _InvalidOperationException : IDispatch {
...
interface _NotSupportedException : IDispatch {
  mixin(uuid("40e5451f-b237-33f8-945b-0230db700bbb"));
}

interface _NullReferenceException : IDispatch {
...
interface _OverflowException : IDispatch {
...
interface _PlatformNotSupportedException : IDispatch {
...
interface _UnauthorizedAccessException : IDispatch {
...
interface _CustomAttributeFormatException : IDispatch {
...
abstract final class StackOverflowException {
  mixin(uuid("9c125a6f-eae2-3fc1-97a1-c0dceab0b5df"));
  mixin Interfaces!(_StackOverflowException, _Object, ISerializable, _Exception);
}
...
abstract final class ArgumentException {
  mixin(uuid("3fdceec6-b14b-37e2-bb69-abc7ca0da22f"));
  mixin Interfaces!(_ArgumentException, _Object, ISerializable, _Exception);
}

abstract final class ArgumentNullException {
  mixin(uuid("3bd1f243-9bc4-305d-9b1c-0d10c80329fc"));
  mixin Interfaces!(_ArgumentNullException, _Object, ISerializable, _Exception);
}

abstract final class ArgumentOutOfRangeException {
  mixin(uuid("74bdd0b9-38d7-3fda-a67e-d404ee684f24"));
  mixin Interfaces!(_ArgumentOutOfRangeException, _Object, ISerializable, _Exception);
}

abstract final class ArithmeticException {
  mixin(uuid("647053c3-1879-34d7-ae57-67015c91fc70"));
  mixin Interfaces!(_ArithmeticException, _Object, ISerializable, _Exception);
}
...
abstract final class BadImageFormatException {
  mixin(uuid("e9148312-a9bf-3a45-bbca-350967fd78f5"));
  mixin Interfaces!(_BadImageFormatException, _Object, ISerializable, _Exception);
}
...
abstract final class FormatException {
  mixin(uuid("964aa3bd-4b12-3e23-9d7f-99342afae812"));
  mixin Interfaces!(_FormatException, _Object, ISerializable, _Exception);
}
...
abstract final class InvalidCastException {
  mixin(uuid("7f6bcbe5-eb30-370b-9f1b-92a6265afedd"));
  mixin Interfaces!(_InvalidCastException, _Object, ISerializable, _Exception);
}

abstract final class InvalidOperationException {
  mixin(uuid("9546306b-1b68-33af-80db-3a9206501515"));
  mixin Interfaces!(_InvalidOperationException, _Object, ISerializable, _Exception);
}
...
abstract final class MulticastNotSupportedException {
  ...
  mixin Interfaces!(_MulticastNotSupportedException, _Object, ISerializable, _Exception);
}
...
abstract final class NotSupportedException {
  mixin(uuid("dafb2462-2a5b-3818-b17e-602984fe1bb0"));
  mixin Interfaces!(_NotSupportedException, _Object, ISerializable, _Exception);
}

abstract final class NullReferenceException {
  mixin(uuid("7f71db2d-1ea0-3cae-8087-26095f5215e6"));
  mixin Interfaces!(_NullReferenceException, _Object, ISerializable, _Exception);
}
...
abstract final class OverflowException {
  mixin(uuid("4286fa72-a2fa-3245-8751-d4206070a191"));
  mixin Interfaces!(_OverflowException, _Object, ISerializable, _Exception);
}
...
abstract final class PlatformNotSupportedException {
  mixin(uuid("a36738b5-fa8f-3316-a929-68099a32b43b"));
  mixin Interfaces!(_PlatformNotSupportedException, _Object, ISerializable, _Exception);
}
...
abstract final class UnauthorizedAccessException {
  mixin(uuid("75215200-a2fe-30f6-a34b-8f1a1830358e"));
  mixin Interfaces!(_UnauthorizedAccessException, _Object, ISerializable, _Exception);
}
...
abstract final class CustomAttributeFormatException {
  mixin(uuid("d5cb383d-99f4-3c7e-a9c3-85b53661448f"));
  mixin Interfaces!(_CustomAttributeFormatException, _Object, ISerializable, _Exception);
}
...
abstract final class SecurityException {
  ...
  mixin Interfaces!(_SecurityException, _Object, ISerializable, _Exception);
}
