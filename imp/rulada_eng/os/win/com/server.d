 ...
 *
 * import os.win.com.all, os.win.utils.registry, hello;
 *
 ...
 * as the client application. This is an XML file that does the same thing as the registry method. Here's an Пример:
 *
 * ---
 * --- client.exe.manifest ---
...
string getLocation() {
  if (location_ == null) {
    ...
    location_ = os.win.base.string.toUtf8(buffer.ptr, 0, len);
  }
  return location_;
}
