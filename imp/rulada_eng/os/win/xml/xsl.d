...
class XsltException : Exception {
   ...
   * Возвращает: The line number indicating where the error occurred.
   */
   ...
   * Возвращает: The line position indicating where the error occurred.
   */
   ...
   * Возвращает: The location path of the style sheet.
   */
...
final class XslTransform {
   ...
   * Выводит исключение: XsltException if the style sheet contains an error.
   */
