...
class XmlNamespaceManager {
   ...
   * Параметры: prefix = The _prefix of the namespace to find.
   ...
   * Возвращает: true if there are namespace scopes left on the stack; otherwise, false.
   */
  bool popScope() {
...
abstract class XmlNodeList {
   ...
   * Параметры: index = The _index into the list of nodes.
   * Возвращает: The node in the collection at index.
   */
