 ...
 * Возвращает: An integer indicating the lexical relationship between the two strings (less than zero if stringA is less then stringB; zero if stringA equals stringB; greater than zero if stringA is greater than stringB).
 */
 ...
 * Возвращает: true if the value parameter occurs within the s parameter; otherwise, false.
 */
 ...
 * Возвращает: The index of value if that character is found, or -1 if it is not.
 */
 ...
 *   count = The number of characters to examine.
 *   ignoreCase = A value indicating a case- sensitive or insensitive comparison.
 * Возвращает: The index of value if that string is found, or -1 if it is not.
 */
 ...
 *   ignoreCase = A value indicating a case- sensitive or insensitive comparison.
 * Возвращает: true if value matches the beginning of s; otherwise, false.
 */
 ...
 *   value = The string to compare.
 *   ignoreCase = A value indicating a case- sensitive or insensitive comparison.
 * Возвращает: true if value matches the end of s; otherwise, false.
 */
 ...
 * Возвращает: A new string with value inserted at index.
 */
 ...
 * Возвращает: A new string equivalent to s less count number of characters.
 */
 ...
 * Возвращает: An array whose elements contain the substrings in s that are delimited by one or more characters in separator.
 */
 ...
 *   count = The maximum number of substrings to return.
 *   removeEmptyEntries = true to omit empty array elements from the array returned, or false to include empty array elements in the array returned.
 * Возвращает: An array whose elements contain the substrings in s that are delimited by one or more strings in separator.
 */
 ...
 * Возвращает: A string containing the strings in value joined by separator.
 */
 ...
 * Возвращает: A string equivalent to s but with all instances of oldChar replaced with newChar.
 */
 ...
 * Возвращает: A string equivalent to s but with all instances of oldValue replaced with newValue.
 */
 ...
 * Возвращает: A string equivalent to s but right-aligned and padded on the left with paddingChar.
 */
 ...
 *   totalWidth = The number of characters in the resulting string.
 *   paddingChar = A padding character.
 * Возвращает: A string equivalent to s but left-aligned and padded on the right with paddingChar.
 */
 ...
 * Возвращает: The string that remains after all occurrences of the characters in trimChars are removed from the start and end of s.
 */
 ...
 * Возвращает: The string that remains after all occurrences of the characters in trimChars are removed from the start of s.
 */
 ...
 * Возвращает: The string that remains after all occurrences of the characters in trimChars are removed from the end of s.
 */
 ...
 * Возвращает: The _substring of length that begins at index in s.
 */
 ...
 * Параметры: s = The string to convert.
 * Возвращает: a string in lowercase.
 */
 ...
 * Параметры: s = The string to convert.
 * Возвращает: a string in uppercase.
 */
 ...
 * Возвращает: A copy of format in which the _format items have been replaced by string representations of the corresponding items in the argument list.
 */
