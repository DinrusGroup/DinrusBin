...
ОкноСооб(null, "Неудачное преобразование из типа ткст", "D рантайм:ОшибкаПреобразования: ", СО_ОК|СО_ПИКТОШИБКА);}
}
...
ОкноСооб(null, "Переполнение стека при преобразовании из типа ткст", "D рантайм: ОшибкаПереполненияПриПреобразовании: ", СО_ОК|СО_ПИКТОШИБКА);}
}
