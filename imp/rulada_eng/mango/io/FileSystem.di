...
class FileSystem
{
                ...
                ***********************************************************************/
                ...
                static char[][] listRoots ()
                {
                        ...
                        if (len)
                           {
                           str = new char [len];
                           GetLogicalDriveStringsA (len, cast(char*) str);
                ...
                ***********************************************************************/
                ...
                static void setDirectory (FilePath fp)
                {
                        version (Win32SansUnicode)
                                ...
                                {
                                if (! SetCurrentDirectoryW (cast(wchar*) fp.toUtf16))
                                      throw new IOException ("Failed to set current directory");
                                }
                }
                ...
                static FilePath getDirectory ()
                {
                        version (Win32SansUnicode)
                                ...
                                if (length)
                                   ...
                                   GetCurrentDirectoryW (length, cast(wchar*) dir);
        ...
        version (Posix)
        {
                ...
                ***********************************************************************/
                ...
                static void setDirectory (FilePath fp)
                {
                        if (std.c.linux.linux.chdir (fp.toUtf8))
                            throw new IOException ("Failed to set current directory");
                }
                ...
                ***********************************************************************/
                ...
                static FilePath getDirectory ()
                {
                        char *s = std.c.linux.linux.getcwd (null, 0);
                        if (s) 
