...
class EndianFilter16 : EndianFilter
{
        ...
        final void swap (void[] x, uint bytes) {ByteSwap.swap16 (cast(void*) x, bytes);}
}
...
class EndianFilter32 : EndianFilter
{
        ...
        final void swap (void[] x, uint bytes) {ByteSwap.swap32 (cast(void*) x, bytes);}
}
