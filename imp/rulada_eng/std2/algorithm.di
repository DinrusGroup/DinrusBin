...
module std2.algorithm;
////version(Tango) import std.compat;
private import std.io;
private import std2.math;
private import std2.random;
private import std.date;
private import std2.functional;
...
unittest
{
    scope(failure) fwritefln(stderr, "Failure testing algorithm");
    auto v = ([ 25, 7, 9, 2, 0, 5, 21 ]).dup;
    auto n = 4;
    nthElement!(less)(v.ptr, v.ptr + n, v.ptr + v.length);
    assert(v[n] == 9);
