...
\***********************************************************************/
module os.win32.oleidl;

// DAC: This is defined in ocidl !!
// what is it doing in here?
//alias IEnumOleUndoUnits* LPENUMOLEUNDOUNITS;

private import os.win32.basetyps, os.win32.objidl, os.win32.unknwn, os.win32.windef,
  os.win32.winuser, os.win32.wtypes;
private import os.win32.objfwd; // for LPMONIKER
private import os.win32.wingdi; // for LPLOGPALETTE
