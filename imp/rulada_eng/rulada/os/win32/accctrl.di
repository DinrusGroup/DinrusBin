...
\***********************************************************************/
module os.win32.accctrl;

private import os.win32.basetyps, os.win32.w32api, os.win32.winbase, os.win32.windef;

// FIXME: check types and grouping of constants
// FIXME: check Windows version support

/*static assert (_WIN32_WINNT_ONLY,
	"os.win32.accctrl is available only if version WindowsNTonly, WindowsXP, "
