...
\***********************************************************************/
module os.win32.lmsvc;

// FIXME: Is this file deprecated? All of the functions are only for Win16.
/**
  Changes relative to MinGW:
  lmsname is not imported publicly (instead, os.win32.lm imports it directly).
*/
// TODO: 5 macros

private import os.win32.lmcons, os.win32.lmsname, os.win32.windef;
