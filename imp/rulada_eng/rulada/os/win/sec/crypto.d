...
import std.c : memmove, malloc, free;
 ...
 * Examples:
 * ---
 * import os.win.base.text, os.win.security.crypto, std.stdio;
 * 
 * void main() {
 ...
 * Examples:
 * ---
 * import os.win.security.crypto, os.win.base.text, std.stdio;
 *
...
static this() {
  nameToHash = [
    "MD5"[]: "os.win.security.crypto.Md5CryptoServiceProvider"[],
    "SHA1": "os.win.security.crypto.Sha1CryptoServiceProvider",
    "SHA256": "os.win.security.crypto.Sha256CryptoServiceProvider",
    "SHA384": "os.win.security.crypto.Sha384CryptoServiceProvider",
    "SHA512": "os.win.security.crypto.Sha512CryptoServiceProvider"
  ];
}
...
private final class CAPITransform : ICryptoTransform {
  ...
  ubyte[] transformFinalBlock(ubyte[] inputBuffer, uint inputOffset, uint inputCount) {
    ...
    ubyte[] depadBlock(ubyte[] block, uint offset, uint count) {
      ...
      //os.win.io.core.Console.writeln(cast(int)(count - padding));
