...
///
module os.win.gui.messagebox;

private import os.win.gui.x.winapi, os.win.gui.x.dlib, os.win.gui.base;
...
/// ditto
DialogResult msgBox(IWindow owner, Dstring txt, Dstring caption, MsgBoxButtons buttons,
	MsgBoxIcon icon, MsgBoxDefaultButton defaultButton, MsgBoxOptions options) ;
