...
interface ICorSvcDependencies : IUnknown {
  ...
  /*[id(0x60010000)]*/ int GetAssemblyDependencies(wchar* pAssemblyName, out SAFEARRAY  pDependencies, out uint assemblyNGenSetting, out wchar* pNativeImageIdentity, out wchar* pAssemblyDisplayName, out SAFEARRAY  pDependencyLoadSetting, out SAFEARRAY pDependencyNGenSetting);
}
...
interface ICorSvcWorker : IUnknown {
  ...
  /*[id(0x60010001)]*/ int OptimizeAssembly(wchar* pAssemblyName, wchar* pApplicationName, OptimizationScenario scenario,  SAFEARRAY loadAlwaysList,  SAFEARRAY loadSometimesList,  SAFEARRAY loadNeverList, out wchar* pNativeImageIdentity);
...
interface IValidator : IUnknown {
  ...
  /*[id(0x60010001)]*/ int FormatEventInfo(int hVECode, tag_VerError Context, ref wchar* msg, uint ulMaxLength, SAFEARRAY  psa);
}

interface IVEHandler : IUnknown {
  mixin(uuid("856ca1b2-7dab-11d3-acec-00c04f86c309"));
  /*[id(0x60010000)]*/ int VEHandler(int VECode, tag_VerError Context, SAFEARRAY  psa);
