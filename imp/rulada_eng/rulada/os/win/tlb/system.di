...
enum CodeBinaryOperatorType {
  Add = 0x00000000,
  Assign = 0x00000005,
  BitwiseAnd = 0x0000000A,
  BitwiseOr = 0x00000009,
  BooleanAnd = 0x0000000C,
  BooleanOr = 0x0000000B,
  Divide = 0x00000003,
  GreaterThan = 0x0000000F,
  GreaterThanOrEqual = 0x00000010,
  IdentityEquality = 0x00000007,
  IdentityInequality = 0x00000006,
  LessThan = 0x0000000D,
  LessThanOrEqual = 0x0000000E,
  Modulus = 0x00000004,
  Multiply = 0x00000002,
  Subtract = 0x00000001,
  ValueEquality = 0x00000008,
}
...
interface IRootDesigner : IDispatch {
  ...
  /*[id(0x60020000)]*/ int get_SupportedTechnologies(out  SAFEARRAY pRetVal);
