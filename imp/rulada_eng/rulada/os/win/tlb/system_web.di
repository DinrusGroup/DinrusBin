...
interface IRemoteWebConfigurationHostServer : IDispatch {
  ...
  /*[id(0x60020000)]*/ int GetData(wchar* fileName, short getReadTimeOnly, out long readTime, out  SAFEARRAY pRetVal);
  /*[id(0x60020001)]*/ int WriteData(wchar* fileName, wchar* templateFileName,  SAFEARRAY data, ref long readTime);
  /*[id(0x60020002)]*/ int GetFilePaths(int webLevel, wchar* path, wchar* site, wchar* locationSubPath, out wchar* pRetVal);
  /*[id(0x60020003)]*/ int DoEncryptOrDecrypt(short doEncrypt, wchar* xmlString, wchar* protectionProviderName, wchar* protectionProviderType,  SAFEARRAY parameterKeys,  SAFEARRAY parameterValues, out wchar* pRetVal);
...
interface _RemoteWebConfigurationHostServer : IDispatch {
  ...
  /*[id(0x60020004)]*/ int GetData(wchar* fileName, short getReadTimeOnly, out long readTime, out  SAFEARRAY pRetVal);
  /*[id(0x60020005)]*/ int WriteData(wchar* fileName, wchar* templateFileName,  SAFEARRAY data, ref long readTime);
  /*[id(0x60020006)]*/ int GetFilePaths(int webLevelAsInt, wchar* path, wchar* site, wchar* locationSubPath, out wchar* pRetVal);
  /*[id(0x60020007)]*/ int DoEncryptOrDecrypt(short doEncrypt, wchar* xmlString, wchar* protectionProviderName, wchar* protectionProviderType, SAFEARRAY paramKeys,  SAFEARRAY paramValues, out wchar* pRetVal);
