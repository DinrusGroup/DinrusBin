...
abstract class XmlReader {
   ...
   * Возвращает: true if the next node was _read successfully; false if there are no more nodes to _read.
   */
  abstract bool read();
   ...
   * Возвращает: true if an attribute exists; otherwise, false.
   */
  abstract bool moveToFirstAttribute();

  /**
   * Moves to the next attribute.
   * Возвращает: true if there is a next attribute; otherwise, false.
   */
...
abstract class XmlWriter {
   ...
   * Возвращает: A new XmlWriter instance.
   */
