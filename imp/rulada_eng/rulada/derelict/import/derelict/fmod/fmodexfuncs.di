// D import file generated from 'fmodexfuncs.d'
...
extern (C) 
{
    ...
    FMOD_RESULT function(FMOD_SYSTEM*, int, FMOD_VECTOR*, FMOD_VECTOR*, FMOD_VECTOR*, FMOD_VECTOR*) FMOD_System_Set3DListenerAttributes;
    ...
    FMOD_RESULT function(FMOD_SYSTEM*, FMOD_REVERB_PROPERTIES*) FMOD_System_SetReverbProperties;
    FMOD_RESULT function(FMOD_SYSTEM*, FMOD_REVERB_PROPERTIES*) FMOD_System_GetReverbProperties;
    FMOD_RESULT function(FMOD_SYSTEM*, FMOD_REVERB_PROPERTIES*) FMOD_System_SetReverbAmbientProperties;
    ...
    FMOD_RESULT function(FMOD_SYSTEM*, void*, int, FMOD_GEOMETRY**) FMOD_System_LoadGeometry;
    FMOD_RESULT function(FMOD_SYSTEM*, FMOD_VECTOR*, FMOD_VECTOR*, float*, float*) FMOD_System_GetGeometryOcclusion;
    ...
    FMOD_RESULT function(FMOD_CHANNEL*, FMOD_VECTOR*, FMOD_VECTOR*) FMOD_Channel_Set3DAttributes;
    ...
    FMOD_RESULT function(FMOD_CHANNELGROUP*, FMOD_REVERB_PROPERTIES*) FMOD_ChannelGroup_OverrideReverbProperties;
    FMOD_RESULT function(FMOD_CHANNELGROUP*, FMOD_VECTOR*, FMOD_VECTOR*) FMOD_ChannelGroup_Override3DAttributes;
    ...
    FMOD_RESULT function(FMOD_GEOMETRY*, float, float, FMOD_BOOL, int, FMOD_VECTOR*, int*) FMOD_Geometry_AddPolygon;
    ...
    FMOD_RESULT function(FMOD_GEOMETRY*, int, int, FMOD_VECTOR*) FMOD_Geometry_SetPolygonVertex;
    ...
    FMOD_RESULT function(FMOD_GEOMETRY*, FMOD_VECTOR*, FMOD_VECTOR*) FMOD_Geometry_SetRotation;
    FMOD_RESULT function(FMOD_GEOMETRY*, FMOD_VECTOR*, FMOD_VECTOR*) FMOD_Geometry_GetRotation;
    FMOD_RESULT function(FMOD_GEOMETRY*, FMOD_VECTOR*) FMOD_Geometry_SetPosition;
    FMOD_RESULT function(FMOD_GEOMETRY*, FMOD_VECTOR*) FMOD_Geometry_GetPosition;
    FMOD_RESULT function(FMOD_GEOMETRY*, FMOD_VECTOR*) FMOD_Geometry_SetScale;
    ...
    FMOD_RESULT function(FMOD_REVERB*, FMOD_VECTOR*, float, float) FMOD_Reverb_Set3DAttributes;
    FMOD_RESULT function(FMOD_REVERB*, FMOD_VECTOR*, float*, float*) FMOD_Reverb_Get3DAttributes;
    FMOD_RESULT function(FMOD_REVERB*, FMOD_REVERB_PROPERTIES*) FMOD_Reverb_SetProperties;
