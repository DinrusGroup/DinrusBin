...
{
    private import rt.core.sync.config;
    private import rt.core.stdc.errno;
    private import rt.core.os.pos.time;
    private import rt.rt.core.os.osx.mach.semaphore;
}
else version( Posix )
{
    private import rt.core.sync.config;
    ...
    private import rt.core.os.pos.semaphore;
}
