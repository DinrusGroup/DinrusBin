 ...
 */
module rt.core.stdc.wchar_;

private import rt.core.stdc.config;
private import rt.core.stdc.stdarg; // for va_list
private import rt.core.stdc.stdio;  // for FILE, not exposed per spec
public import rt.core.stdc.stddef;  // for size_t, wchar_t
public import rt.core.stdc.time;    // for tm
public import rt.core.stdc.stdint;  // for WCHAR_MIN, WCHAR_MAX
