...
alias ук HANDLE;
	...
	extern (Windows) HANDLE GetCurrentThreadHandle();
...
extern (D) class Thread
	...
	alias setLocal устЛокальн;
		...
		static const int PRIORITY_MIN = -15;
		static const int PRIORITY_MAX = 15;
	...
	extern (D) void closeModule();
	
	static ~this();//{closeModule();}
	...
	////////////////////////////////////////////////////////////////////////////////
		...
		extern (D) static size_t getPagesize();
	...
	////////////////////////////////////////////////////////////////////////////////
 export	extern (C) void fiber_entryPoint();
 export extern (C) void fiber_switchContext( void** oldp, void* newp );
...
version(Static)
{
	...
	import rt.core.sync.atomic, object;
	debug(Thread)
	...
	version( Win32 )
	{
		private
		{
			import rt.core.stdc.stdint : uintptr_t; // for _beginthreadex decl below
			import os.windows;
	...
	else version( Posix )
	{
		private
		{
			import rt.core.os.posix.semaphore;
			import rt.core.os.posix.pthread;
			import rt.core.os.posix.signal;
			import rt.core.os.posix.time;
			import rt.core.stdc.errno;
	...
	body
	{
	debug(PRINTF) printf(" thread_scanAll\n");
