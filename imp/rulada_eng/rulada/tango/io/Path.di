...
private import rt.core.stdc.string : memmove;
...
version (Posix)
        ...
        private import rt.core.stdc.string;
        ...
        ***********************************************************************/
        ...
        version (Posix)
        {
                ...
                ***************************************************************/
                ...
                static bool remove (char[] name)
                {
                        return rt.core.stdc.stdio.remove(name.ptr) != -1;
                }
                ...
                ***************************************************************/
                ...
                static void rename (char[] src, char[] dst)
                {
                        if (rt.core.stdc.stdio.rename (src.ptr, dst.ptr) is -1)
                            exception (src);
                }
                ...
                ***************************************************************/
                ...
                static int list (char[] folder, int delegate(ref FileInfo) dg, bool all=false)
                {
                        ...
                        dir = rt.core.stdc.posix.dirent.opendir (folder.ptr);
                        if (! dir)
                              return ret;

                        scope (exit)
                               rt.core.stdc.posix.dirent.closedir (dir);
                        ...
                        while (true)
                              ...
                              auto len = rt.core.stdc.string.strlen (entry.d_name.ptr);
