...
class image : image_interface
{
    ...
    ELF_verify(io_stream file)
    {
        ...
        if ((id[EI_DATA] == ELFDATA2MSB && .endian == Endian.LittleEndian) ||
            (id[EI_DATA] == ELFDATA2LSB && .endian == Endian.BigEndian))
            super.endian = true;
...
class PT : mine!(Phdr)
{
    ...
    this(image img, lazy DT dynamic, uint[] mask = null)
    {
