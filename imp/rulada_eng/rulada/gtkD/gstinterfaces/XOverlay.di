...
module gtkD.gstinterfaces.XOverlay;

public  import gtkD.gstreamerc.gstinterfacestypes;

private import gtkD.gstreamerc.gstinterfaces;
...
version (build) {
    debug {
        version (GNU) {
            pragma(link, "DG-gstinterfaces");
        } else version (DigitalMars) {
            pragma(link, "DD-gstinterfaces");
        } else {
            pragma(link, "DO-gstinterfaces");
        }
    } else {
        version (GNU) {
            pragma(link, "DG-gstinterfaces");
