...
module mango.servlet.ServletProvider;
...
private import  mango.servlet.Servlet,
                ...
                mango.servlet.ServletRequest,
                mango.servlet.ServletResponse;

private import  mango.http.server.HttpRequest,
...
class ServletProvider : IProvider
{
        ...
        **********************************************************************/
        ...
        body
        {
                ...
                mappings ~= new ServletMapping (servlet, new RegExp(pattern, null));
