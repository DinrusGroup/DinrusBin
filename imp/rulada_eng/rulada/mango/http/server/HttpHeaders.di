...
module mango.http.server.HttpHeaders;
...
/******************************************************************************
        ...
        buffer and indexed via a TokenStack. 
...
class HttpHeaders : HttpTokens
{
        ...
        /**********************************************************************
                ...
                Construct this set of headers, using a TokenStack based
                upon a ':' delimeter   
...
/******************************************************************************
        ...
        buffer, and indexed via a TokenStack. Deleting a header could be 
        supported by setting the TokenStack entry to null, and ignoring
