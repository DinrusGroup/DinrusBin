...
module mango.log.PropertyConfigurator;

version (Isolated) {}
else
{
private import  mango.io.Properties;

private import  mango.log.Logger,
                mango.log.Layout,
                mango.log.DateLayout,
                mango.log.Configurator,
                mango.log.ConsoleAppender;
...
/*******************************************************************************
        ...
        property file. Mango.log only supports the settings of Logger 
