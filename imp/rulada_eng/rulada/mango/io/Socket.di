...
/*******************************************************************************
        ...
        1) It has been altered to fit within the Mango environment, meaning
           ...
           derives from class mango.io.Resource.
...
private import  mango.io.Conduit,
                mango.io.Exception;
	...
	private bool		timeout;
        ...
        ***********************************************************************/
        ...
        protected static char[] hostName ()
        {
                ...
                if(SOCKET_ERROR == .gethostname (cast(void*) name, name.length))
                   exception ("Unable to obtain host name: ");
                return name [0 .. strlen(cast(char*) name)].dup;
        }
        ...
        ***********************************************************************/
        ...
        {
                int sent = .send (sock, cast(void*) buf, buf.length, cast(int)flags);
                return sent;
        }
        ...
        ***********************************************************************/
        ...
        {
                int sent = .sendto (sock, cast(void*) buf, buf.length, cast(int)flags, to.name(), to.nameLen());
                return sent;
        }
        ...
        ***********************************************************************/
        ...
        {
                int sent = .sendto (sock, cast(void*) buf, buf.length, cast(int)flags, null, 0);
                return sent;
        }
        ...
        ***********************************************************************/
        ...
        protected int receive (void[] buf, Flags flags = Flags.NONE)
        {
                if(!buf.length) //return 0 and don't think the connection closed
                        return 0;
                int read = .recv(sock, cast(void*) buf, buf.length, cast(int)flags);
        ...
        ***********************************************************************/
        ...
        protected int receiveFrom (void[] buf, Flags flags, out Address from)
        {
                ...
                int read = .recvfrom (sock, cast(void*) buf, buf.length, cast(int)flags, from.name(), &nameLen);
                version (TraceLinux)
                        {
        ...
        ***********************************************************************/
        ...
        protected int receiveFrom (void[] buf, Flags flags)
        {
                if(!buf.length) //return 0 and don't think the connection closed
                        return 0;
                int read = .recvfrom (sock, cast(void*) buf, buf.length, cast(int)flags, null, null);
                if (read == SOCKET_ERROR)
                    exception ("during socket recieve: ");
        ...
        ***********************************************************************/
        ...
        protected int getOption (OptionLevel level, Option option, void[] result)
        {
                ...
                if(SOCKET_ERROR == .getsockopt (sock, cast(int)level, cast(int)option, cast(char*) result, &len))
        ...
        ***********************************************************************/
        ...
        {
                if(SOCKET_ERROR == .setsockopt (sock, cast(int)level, cast(int)option, cast(void*) value, value.length))
        ...
        ***********************************************************************/
        ...
        this(uint max)
        {
                version(Win32)
                {
                        ...
                        buf = cast(byte*)(new byte[nbytes + uint.sizeof]);
                        count = 0;
                }
                else version (Posix)
                {
...
/******************************************************************************/
/******************* additions for the mango.io package  **********************/           
/******************************************************************************/
