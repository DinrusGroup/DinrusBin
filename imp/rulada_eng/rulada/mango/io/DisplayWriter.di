...
/*******************************************************************************
        ...
        Note that DisplayWriter itself is a wrapper around the mango.convert 
        ...
        Mango.convert also has Format and Sprint classes for working directly
        with text arrays.
...
class DisplayWriter : Writer
{
        ...
        ***********************************************************************/
        ...
        /***********************************************************************
                ...
                mango.convert.Format for details
        ...
        ***********************************************************************/
        ...
        {
                encode (cast(void*) x, x.length, type);
                return x.length;
        }
}
