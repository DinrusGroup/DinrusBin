 ...
 */
alias SqliteDatabase БДСклайт;
class SqliteDatabase : Database {

alias connect подключи;
alias close закрой;
alias execute выполни;
alias query запроси;
alias getLastInsertRowId дайИдСтрокиПоследнейВставки;
alias getChanges дайИзменения;
alias getTableNames дайИменаТаблиц;
alias getViewNames дайИменаОбзора;
alias getIndexNames дайИменаИндексов;
alias hasTable естьТаблица_ли;
alias hasView естьОбзор_ли;
alias hasIndex естьИндекс_ли;
