...
import amigos.minid.astvisitor;
import amigos.minid.codegen;
import amigos.minid.compilertypes;
import amigos.minid.interpreter;
import amigos.minid.lexer;
import amigos.minid.parser;
import amigos.minid.semantic;
...
// ================================================================================================================================================
	...
	*/
	...
	As an example, this is used by MDCL (that is, amigos.minid.commandline) to detect when more code must be entered
...
-----
	...
	*/
	...
	Params:
		source = The source code as a amigos.minid.string.
