...
class RefManager
{
	...
	*/
	static class Ref
	{
		...
		/**
		Removes the reference using $(D amigos.minid.interpreter.removeRef).  You can call this manually, or it will be called
		...
		*/
		...
		/**
		Push the reference using $(D amigos.minid.interpreter.pushRef).  It is pushed onto the current thread of the VM in which
		it was created.
	...
	/**
	Create a reference object to refer to the object at slot idx in thread t using $(D amigos.minid.interpreter.createRef).  The
