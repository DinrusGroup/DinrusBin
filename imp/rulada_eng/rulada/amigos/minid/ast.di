...
class AssertStmt : Statement
{
	...
	*/
	...
	based on its location.  If it's not null, it must evaluate to a amigos.minid.string.
	*/
...
{
	/**
	The name.  This can be any expression, as long as it evaluates to a amigos.minid.string.  An
