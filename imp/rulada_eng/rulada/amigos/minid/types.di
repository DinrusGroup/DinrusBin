...
throwException does).  See throwException and catchException in amigos.minid.interpreter for more info
...
"haltThread" function in amigos.minid.interpreter.
*/
