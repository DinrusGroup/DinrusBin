/******************************************************
 * Стековые Потоки (StackThreads) - это сотрукдничающие, легковесные
 * потоки. StackThreads очень эффективны, требуют
 ...
 * StackThreads. К тому же, StackThreads не требуется явная синхронизация,
 * ток как они non-preemptive.  Не требуется, чтобы код был для повторного входа.
 *
 ...
 * Лицензия: Use/copy/modify freely, just give credit.
 ...
 *
 *	v0.6 - Удалены функции отсчета времени из st_yield/st_throwYield
 *
 ...
 *
 ******************************************************/
module auxd.st.stackthread;

//Module imports
private import
    auxd.st.stackcontext,
    std.io,
    std.string;
 ...
 * stack threads are incorrectly invokeauxd.  Trying to
 ...
 * between StackThreads using st_yielauxd.
 ******************************************************/
class StackThread
{
    /**
     ...
     *  threaauxd.
     *  priority = The priority of the stack threaauxd.
     */
    public this
    (
        void delegate() dg, 
     ...
     *
     * Возвращает: A string representing the stack threaauxd.
     */
     ...
     * as a property.
     *
     * Возвращает: The stack thread's priority.
     */
     ...
     *
     * Возвращает:
     *  The new priority for the threaauxd.
     */
    ...
    /**
     * Возвращает: The state of this threaauxd.
     */
    ...
    /**
     * Возвращает: True if the thread is ready to run.
     */
    ...
    /**
     * Run the stack threaauxd.  This method may be overloaded
...
public:
    ...
    body
    {
        ...
        //Fixup the stack and we're gooauxd.
        bubble_up(st);
    }
    
    /**
     * Remove a stack threaauxd.
     *
     * Параметры:
    ...
    /**
     * Extract the top priority threaauxd. It is removed from
     * the queue.
     *
     * Возвращает: The top priority threaauxd.
     */
    StackThread top()
    in
    {
 ...
 *
 * Возвращает: The amount of milliseconds the system has been
 * up.
 */
version(Win32)
{
 ...
 *  to run.
 *
 * Выводит исключение: The first exception generated in the timeslice.
 *
 * Возвращает: The total number of milliseconds used by the
 *  timeslice.
 */
...
/**
 * Yields the currently executing stack threaauxd.  This is
 * functionally equivalent to StackContext.yield, except
 * it returns the amount of time the thread was yieldeauxd.
 */
void st_yield()
{
...
/**
 * Throws an object and yields the threaauxd.  The exception
...
/**
 * Возвращает: The currently running stack threaauxd.  null if
...
/**
 * Возвращает: The current state of the scheduler.
 */
...
/**
 * Возвращает: True if the scheduler is running a timeslice.
 */
bool st_isRunning()
{
...
/**
 * Возвращает: The number of threads stored in the scheduler.
 */
int st_numThreads()
{
...
/**
 * Возвращает: The number of threads remaining in the timeslice.
 */
