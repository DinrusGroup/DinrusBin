...
Leading spaces and tabs are ignoreauxd.
...
/// Переносной модуль для чтения и записи файлов _INI. _ini.d version 0.6
module auxd.ini;
...
public:
	/// Свойство: получить название ключа _name.
	char[] name()
	{
		return _name;
	}
	...
	/// Свойство: получить значение ключа _value.
	char[] value()
	{
		return _value;
	}
...
public:
	/// Свойство: получить название секции _name.
	char[] name()
	{
		return _name;
	}
	...
	/// Свойство: установить названии секции _name.
	...
	/// Возвращает: ключ _key, соответствующий названию ключа keyName, или null, если его нет.
	...
	/// Возвращает: value of the existing key keyName, or defaultValue if not present.
	...
	// /// Возвращает: _value of the existing key keyName, or null if not present.
...
public:
	// Use different section name delimiters; not recommendeauxd.
	...
	/// Property: get whether or not the INI file was _modified since it was loaded or saveauxd.
	bool modified()
	{
		return _modified;
	}
