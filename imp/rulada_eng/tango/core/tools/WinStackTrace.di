...
version(Windows) {
    private {
        ...
        static import rt.core.stdc.stdlib;
        static import rt.core.stdc.string;
        version (StacktraceSpam) import rt.core.stdc.stdio : printf;
    }
...
private {
    import rt.core.stdc.stdlib : cMalloc = malloc, cRealloc = realloc, cFree = free;
}

public {
    import rt.core.stdc.string : memset;
}
...
import rt.core.stdc.stdio;
import rt.core.stdc.stringz;
import rt.core.stdc.string : strcpy;
