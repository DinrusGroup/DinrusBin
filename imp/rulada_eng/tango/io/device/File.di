...
private import stdc = rt.core.stdc.stringz;
...
/*******************************************************************************
        ...
        Реализует средство для записи и чтения генерных файлов. Потоки - 
        это первичное средство доступа к внешним данным, а File
        расширяет базовый образец, предоставляя зависящие от файла методы
        для установки размера файла, перехода на определенную позицию в файле
		и проч.
