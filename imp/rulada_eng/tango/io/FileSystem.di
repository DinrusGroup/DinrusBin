...
version (Win32)
        ...
        private import rt.core.stdc.stringz : fromString16z, fromStringz;
        ...
        version (Posix)
        {
                ...
                ***************************************************************/
                ...
                deprecated static void setDirectory (char[] path)
                {
                        ...
                        if (rt.core.stdc.posix.unistd.chdir (tmp.ptr))
                            exception ("Failed to set current directory");
                }
                ...
                ***************************************************************/
                ...
                deprecated static char[] getDirectory ()
                {
                        ...
                        char *s = rt.core.stdc.posix.unistd.getcwd (tmp.ptr, tmp.length);
                        if (s is null)
                            exception ("Failed to get current directory");
