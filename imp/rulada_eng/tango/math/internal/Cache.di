...
public:
    ...
    /// Intel Atom 230/330 (family 6, model 0x1C) is an in-ordertango.core.
	/// Centaur Isiah = VIA Nano (family 6, model F) is an out-of-ordertango.core.
    ///
...
void getAMDcacheinfo()
{
	...
	if (max_extended_cpuid >= 0x8000_0006) {
		...
		// The L3 cache value is TOTAL, not pertango.core.
