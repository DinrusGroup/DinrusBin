...
module amigos.dlua.mixins;

private import amigos.dlua.common;
public import amigos.dlua.error;
private import amigos.dlua.utils;
public import amigos.dlua.utils;
public import amigos.dlua.lauxlib;
private import amigos.dlua.lua;
...
public static istring mixinLuaRegisterMethodAtLine (cstring lua_state, cstring class_name, cstring method_name, cstring lua_name, int line_number)
{
    ...
    return cast(istring) (`{`
        ...
        ~ `      return luaL_error (L, amigos.dlua.utils.toStringz ("LFE=" ~ amigos.dlua.mixins.int2string (cast (size_t) cast(void*)  f) ~ ";"));`
        ~ `    }`
        ~ `  }`
