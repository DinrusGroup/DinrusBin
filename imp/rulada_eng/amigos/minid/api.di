...
imports the following modules: amigos.minid.alloc, amigos.minid.ex, amigos.minid.interpreter,
amigos.minid.serialization, amigos.minid.types, amigos.minid.utils, and amigos.minid.vm.
...
public
{
	...
	import amigos.minid.serialization;
...
import amigos.minid.arraylib;
import amigos.minid.baselib;
import amigos.minid.charlib;
import amigos.minid.debuglib;
import amigos.minid.hashlib;
import amigos.minid.iolib;
import amigos.minid.mathlib;
import amigos.minid.oslib;
import amigos.minid.regexplib;
import amigos.minid.streamlib;
import amigos.minid.stringlib;
import amigos.minid.threadlib;
