...
Some of it is defined in amigos.minid.interpreter, since D hates circular imports.
...
void free(MDVM* vm, GCObject* o)
{
	...
	{
		case MDValue.Type.String:    amigos.minid.string.string.free(vm, cast(MDString*)o); return;
