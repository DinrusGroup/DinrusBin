...
in the amigos.minid.misc module.
...
/**
See if a string starts with another amigos.minid.string.  Useful.
*/
...
/**
See if a string ends with another amigos.minid.string.  Also useful.
*/
...
/**
Make a FOURCC code out of a four-character amigos.minid.string.  This is I guess for little-endian platforms..
*/
