...
module amigos.dmdscript.dobject;
...
import amigos.dmdscript.iterator;
...
import amigos.dmdscript.dboolean;
import amigos.dmdscript.dstring;
import amigos.dmdscript.dnumber;
import amigos.dmdscript.darray;
import amigos.dmdscript.dmath;
import amigos.dmdscript.ddate;
import amigos.dmdscript.dregexp;
import amigos.dmdscript.derror;
import amigos.dmdscript.dnative;

import amigos.dmdscript.protoerror;
int* pfoo = &amigos.dmdscript.protoerror.foo;	// link it in
...
class Dobject
{
	...
	//writef("\tstd_x_prototype = %p\n", this.std_x_prototype);
...
version (none)
{
    ...
    writef("offsetof(std_x_prototype) = %d\n", offsetof(Dobject, std_x_prototype));
