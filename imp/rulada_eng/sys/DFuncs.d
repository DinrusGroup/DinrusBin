...
///КОНСОЛЬ	
	...
	бул  ЧитайКонсольныйВыводА(ук консВых, ИНФОСИМ* буф, КООРД буфРазм, КООРД буфКоорд, МПРЯМ* регЧтен);
	бул  ЧитайКонсольныйВывод(ук консВых, ИНФОСИМ* буф, КООРД буфРазм, КООРД буфКоорд, МПРЯМ* регЧтен);
	/+
	бул ЧитайВыводКонсолиАкаст(ук консВых, in ИНФОСИМ *буф, КООРД буфРазм, КООРД буфКоорд, МПРЯМ *регЗап);
	бул ПишиНаВыводКонсолиКаст(ук консВых, in ИНФОСИМ *буф, КООРД буфРазм, КООРД буфКоорд, МПРЯМ *регЗап);
	+/
	бул ЧитайСимИзВыводаКонсолиА(ук консВых, сим *симв, бцел длина, КООРД коордЧтен, бцел *члоСчитСим);
	бул ЧитайСимИзВыводаКонсоли(ук консВых, шим *симв, бцел длина, КООРД коордЧтен, бцел *члоСчитСим);
	/+
	бул ЧитайАтрибутВыводаКонсолиКаст(ук консВых, бкрат *атр, бцел длина, КООРД коордЧтен, бцел *члоСчитАтров);
	бул ПишиАтрибутВыводаКонсолиКаст(ук консВых, сим *симв, бцел длина, КООРД коордЗап, бцел *члоСчитАтров);
+/
